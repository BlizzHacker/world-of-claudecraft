...
const MUSIC_ZONE_LABELS: Partial<Record<MusicZone, string>> = {
  ...
  vale_legacy: 'Eastbrook Vale',
  marsh: 'The Mirefen Marsh',
  peaks: 'Thornpeak Heights',
  vale_cup: 'The Vale Cup',
...
export class MusicDirector {
  ...
  // synth stays silent so the two don't stack. The dedicated Nythraxis boss
  // track also owns the mix while active.
