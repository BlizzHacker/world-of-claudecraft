// Fetch wrapper for the /mod/api/* endpoints. Same envelope + Bearer flow as
// the admin and user APIs, scoped to moderator-gated routes.

const TOKEN_KEY = 'cryptic-realm_mod_token';
const NAME_KEY = 'cryptic-realm_mod_name';
