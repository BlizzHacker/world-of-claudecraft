...
export const hudChromeStrings = {
  ...
  dailyRewards: {
    ...
    intro:
      'Hold enough $CR in your verified wallet to unlock daily rewards. Earn points with one daily spin and rotating tasks, then climb the daily leaderboard for a share of the prize pool.',
    disclaimer:
      '$CR price can move quickly. We recommend holding more than the $20 USD minimum so normal price swings do not lock you out. This is not financial advice.',
    prize: 'Prize Pool',
    reset: 'Reset',
    endsIn: 'Ends in {time}',
  ...
  nativeUpdate: {
    ...
    bodyWithVersion:
      'Version {version} of Cryptic Realm is available. Update now for the latest fixes and improvements.',
    notNow: 'Not now',
    update: 'Update',
  },
  ...
  leaderboard: {
    close: 'Close',
    // The realm filter's cross-realm chip on the home-page High Scores board.
    filterAll: 'All',
  ...
  arcade: {
    ...
    code: 'Session code',
    controls:
      'Controls: arrows/WASD to steer or move, Space to drift or jump, J/K to attack, E to use an item.',
