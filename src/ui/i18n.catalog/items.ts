...
const itemNamesEn = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      'Bristly Boar Hide',
      "Gravecaller's Sigil",
      'Hellmaw Binding Ward',
        "The Render's Hateforged Cleaver",
        'Brand of the Hellmaw',
        'Hollow Fang of the Well',
      'Blessed Tallow',
      'Ghostly Essence',
      'Sableweb Silk Gland',
      'Stolen Supply Crate',
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Sigilo del Odio',
        'Hendedora Forjaodio de Baelgor',
        'Sigilmarca de la Durancia',
        'Colmillo Hueco del Odio',
        'Sebo bendito',
        'Esencia fantasmal',
        ...
        'Pico de Minería de Mithril',
        'Hacha de Mano',
        'Hacha de Tala',
        'Hacha de Corteza de Hierro',
        'Hoz de Recolección',
        'Hoz de Bronce',
        'Hoz de Hoja de Plata',
        'Pico de Minería de Torio',
        'Pico de Minería de Arcanita',
        'Hacha de Fresno',
        'Hacha de Madera Añeja',
        'Hoz de Hoja Dorada',
        'Hoz de Pétalo Solar',
        'Mineral de Torio',
        'Barra de Arcanita',
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Sceau de la Haine',
        'Fendoir Forgehaine de Baelgor',
        'Sceau-marque de la Durance',
        'Croc Creux de la Haine',
        'Suif béni',
        'Essence spectrale',
        ...
        'Pic de Minage en Mithril',
        'Hachette',
        "Hache d'Abattage",
        "Hache d'Écorce de Fer",
        'Faucille de Récolte',
        'Faucille de Bronze',
        "Faucille Feuille d'Argent",
        'Pic de Mineur au Thorium',
        "Pic de Mineur à l'Arcanite",
        'Hache en Bois de Frêne',
        'Hache en Bois Ancien',
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Sigillo dell'Odio",
        'Mannaia Forgiaodio di Baelgor',
        'Marchio Sigillo della Durance',
        "Zanna Cava dell'Odio",
        'Sego benedetto',
        'Essenza spettrale',
        ...
        'Falcetto di Bronzo',
        'Falcetto Fogliargento',
        'Piccone da Minatore al Torio',
        "Piccone da Minatore all'Arcanite",
        'Ascia di Frassino',
        'Ascia di Legno Antico',
        'Falcetto Fogliadoro',
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Gravecallers Siegel',
        'Siegel des Hasses',
        'Baelgors Hassgeschmiedeter Spalter',
        'Siegelbrand der Durance',
        'Hohler Zahn des Hasses',
        'Gesegneter Talg',
        'Geisterhafte Essenz',
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Sigilo de Gravecaller',
        'Sigilo do Ódio',
        'Cutelo Forjaódio de Baelgor',
        'Sigilmarca da Durância',
        'Presa Oca do Ódio',
        'Sebo abençoado',
        'Essência espectral',
        ...
        'Foice de Coleta',
        'Foice de Bronze',
        'Foice Folha de Prata',
        'Picareta de Tório',
        'Picareta de Arcanita',
        'Machado de Freixo',
        'Machado de Madeira Antiga',
        'Foice Folha Dourada',
        'Foice Petala Solar',
        'Minério de Tório',
        'Barra de Arcanita',
  ...
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        'Печать Ненависти',
        'Ненавистный тесак Бэлгора',
        'Печать-клеймо Дюранса',
        'Полый клык ненависти',
        'Благословенное сало',
        'Призрачная эссенция',
