  ...
  es: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Brida de ciervo del bosque',
        'Silla de raptor lancero',
        'Riendas del vermis esmeralda',
        'Hierba enredada',
        'Grebas Guardamarea',
  ...
  fr_FR: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Bride de cerf des bois',
        'Selle de raptor-harpon',
        'Rênes du ver émeraude',
        'Herbe emmêlée',
        'Grèves Garde-marée',
  ...
  it_IT: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Briglia del cervo silvano',
        'Sella del raptor palustre',
        'Redini del wyrm di smeraldo',
  ...
  pt_BR: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Rédea do cervo da floresta',
        'Sela do raptor do pântano',
        'Rédeas do vorme esmeralda',
        'Erva emaranhada',
        'Grevas Guardamaré',
        'Escarpes Guardamaré',
  ...
  ru_RU: {
    items: mergeNameTranslations(
      ...
      [
        ...
        'Туфли Сейблвеб',
        'Простая удочка',
        'Уздечка лесного оленя',
        'Седло болотного раптора',
        'Поводья изумрудного змея',
        'Спутанные водоросли',
