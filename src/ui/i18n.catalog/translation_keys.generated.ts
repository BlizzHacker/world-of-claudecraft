...
export type TranslationKeyFlat =
  ...
  | 'hudChrome.waypoints.choose'
  | 'hudChrome.waypoints.discoveredGroup'
  | 'hudChrome.waypoints.filterPlaceholder'
  | 'hudChrome.waypoints.locked'
  | 'hudChrome.waypoints.noMatches'
  | 'hudChrome.waypoints.summary'
  | 'hudChrome.waypoints.title'
  | 'hudChrome.waypoints.undiscovered'
