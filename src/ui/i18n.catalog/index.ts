...
export const en = {
  ...
  news: {
    ...
    // NOTE: upstream v0.17.0 kept a shorter news object (title/desc/loading/error/empty/prerelease/viewOnGithub); we keep our richer news block below, which is a superset.
  ...
  wallet: {
    ...
    holderTiers: {
      ...
      vaultwarden: { name: 'Vaultwarden', flavor: 'Guarding a real vault now: 0.01% of all $CR.' },
  ...
  playerCard: {
    ...
    shareText:
      "I'm forging my legend in Cryptic Realm: Level {level} {className}{tierBit}. Join my realm:",
