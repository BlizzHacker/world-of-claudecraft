...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Cryptic Realm 公式サイト',
  'seo.officialBody':
    'crypticrealm.com は Cryptic Realm ワールドの公式無料ブラウザMMOです。永続キャラクターでオンラインプレイし、オフラインでソロ探索し、wikiを読み、このサイトから確認済みのコミュニティリンクをたどれます。',
  ...
  'wallet.balanceTitle': '認証済みSolanaウォレットの$CR残高',
  'wallet.balanceAria': '認証済みSolanaウォレット残高: {balance}',
  'wallet.balancePreviewTitle': '接続中ウォレットの$CR残高プレビュー',
  ...
  'wallet.standaloneAppHelp':
    'ホーム画面アプリでは、まだウォレットに接続できません。Phantom または Solflare を使用するには、Safari か Chrome で Cryptic Realm を開いてください。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '承認後、ホーム画面から Cryptic Realm に戻ってください。iOS でブラウザが開いた場合は閉じ、ホーム画面のアプリをもう一度開いてください。',
  ...
  'wallet.browser.safety':
    'Cryptic Realmがリカバリーフレーズや秘密鍵を求めることはありません。',
  ...
  'wallet.browser.completeBody': 'Cryptic Realmデスクトップアプリに戻れます。',
  ...
  'wallet.holder': '$CRホルダー',
  'wallet.holderTierTitle': '{tier} $CRホルダー',
  ...
  'wallet.holderTiers.vaultwarden.flavor': '今や本物の金庫を守っています: $CR 全体の 0.01%。',
  ...
  'playerCard.shareTierBit': ', {tier}ランクの$CRホルダー',
  'playerCard.shareText':
    'Cryptic Realmで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:',
  ...
  'seo.title': 'Cryptic Realm: クラシック風Web MMO',
  'seo.description':
    'ブラウザで直接遊べるクラシック風マイクロMMO、Cryptic Realm で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'GitHubでCryptic Realmプロジェクトを開く',
  'a11y.discordCommunity': 'Cryptic RealmのDiscordコミュニティに参加',
  'a11y.donateProject': 'Cryptic Realmを支援するために寄付',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '新しいホーム画面アイコンからCryptic Realmを開きます。',
  ...
  'mobilePreflight.androidOpenStep': '新しいアイコンからCryptic Realmを開きます。',
  ...
  'serverUnavailable.title': 'Cryptic Realm - ワールド利用不可',
  ...
  'serverUnavailable.body':
    'ゲームサービスを再起動しています。Cryptic Realmはまもなく戻る予定です。このページは自動的に確認を続けます。',
  ...
  'hudChrome.account.sectionWallet': '$CR ウォレット',
  ...
  'guide.worldPage.intro':
    'Cryptic Realmは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Cryptic Realmのチャンピオン',
  ...
  'hudChrome.nativeUpdate.body':
    'Cryptic Realm の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Cryptic Realm のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  ...
  'desktop.crash.fatalBody': 'Cryptic Realm で予期しないエラーが発生したため、終了します。',
  ...
  'editor.docTitle': 'マップエディター - Cryptic Realm',
  ...
  'entities.npcs.skirmish_builder.greeting': '斧かツルハシか、司令官殿——指させばいい。',
  'entities.npcs.skirmish_builder.name': '軍営の建築士',
  'entities.npcs.skirmish_builder.title': 'ウォーキャンプ・スカーミッシュ',
  'entities.npcs.skirmish_footman.greeting': '賊団の方角を示してくれ。',
  'entities.npcs.skirmish_footman.name': '軍営の歩兵',
  'entities.npcs.skirmish_footman.title': 'ウォーキャンプ・スカーミッシュ',
  'entities.npcs.skirmish_post.greeting': '軍営は持ちこたえている。',
  'entities.npcs.skirmish_post.name': '軍営の建造物',
  'entities.npcs.skirmish_post.title': 'ウォーキャンプ・スカーミッシュ',
