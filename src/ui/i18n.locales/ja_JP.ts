...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'crypticrealm.com は Claudemoon レルムの公式無料ブラウザMMOです。永続キャラクターでオンラインプレイし、オフラインでソロ探索し、wikiを読み、このサイトから確認済みのコミュニティリンクをたどれます。',
  ...
  'playerCard.defaultRealm': 'Cryptic Realmの世界',
  ...
  'playerCard.shareText':
    'Cryptic Realmで伝説を鍛えています: レベル{level} {className}{tierBit}。私のレルムに参加してください:',
  'playerCard.nativeShareTitle': 'Cryptic Realmの世界',
  ...
  'serverUnavailable.title': 'Cryptic Realm - レルム利用不可',
  ...
  'mode.caNote':
    'CRはコミュニティトークンです。プレイには必要ありません。Discordに参加して、CRのユーティリティとフライホイールについて語り合いましょう。',
  'mode.play': 'プレイ',
  ...
  'auth.hardcoreHint': 'パーマデス。このキャラクターが死亡すると、永久に引退となり二度とプレイできません。復活はありません。',
  'auth.ladderChar': 'ラダーキャラクター',
  'auth.ladderHint': 'シーズンラダーで競います。シーズン終了後は通常キャラクターに変換されます（進行状況はすべて維持）。',
  'auth.ssoMoveweight': 'MoveWeightでサインイン',
  'auth.ssoProviders': 'Google、Facebook、Plex、またはDiscordで続行',
  'hud.options.controller': 'コントローラー',
  'hud.options.controllerDisconnected': '未接続',
  'hud.options.customization': 'カスタマイズ',
  'hud.options.padAttackTarget': '最も近い敵を攻撃・ターゲット',
  'hud.options.padCursorNote': 'メニュー、クエストダイアログ、チャットが開くと、画面上のカーソルが自動的に有効になります——スティックで移動し、Aボタンでクリックします（クエストの受諾、チャットの送信、メニューの使用）。',
  'hud.options.padCursorToggle': 'マウスカーソルの切り替え',
  'hud.options.padInteract': 'インタラクト / NPCと話す',
  'hud.options.padJumpClick': 'ジャンプ・カーソルモードでクリック',
  'hud.options.padLeftStick': '左スティック',
  'hud.options.padLookCursor': '視点操作 / カーソル移動',
  'hud.options.padLtRt': 'LT / RT（長押し）',
  'hud.options.padMenu': 'ゲームメニューを開く',
  'hud.options.padRightStick': '右スティック',
  'hud.options.padSkillChords': '長押し + A/B/X/Yでスキル9〜16',
  'hud.options.padSkills12': 'スキル1・2',
  'hud.options.padSkills47': 'スキル5〜8',
  'hud.options.padStart': 'スタート / メニュー',
  'hud.options.reportBug': 'バグを報告',
  'nav.contributions': 'コントリビューション',
