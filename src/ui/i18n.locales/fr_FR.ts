...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'crypticrealm.com est le MMO gratuit officiel sur navigateur du royaume Claudemoon. Jouez en ligne avec un personnage persistant, explorez en solo hors ligne, lisez le wiki et suivez les liens communautaires vérifiés depuis ce site.',
  ...
  'playerCard.shareText':
    'Je forge ma légende dans Cryptic Realm: niveau {level} {className}{tierBit}. Rejoignez mon royaume:',
  ...
  'serverUnavailable.title': 'Cryptic Realm - Royaume indisponible',
