...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'crypticrealm.com 是 Cryptic Realm 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'wallet.standaloneAppHelp':
    '主屏幕应用暂不支持连接钱包。若要使用 Phantom 或 Solflare，请在 Safari 或 Chrome 中打开 Cryptic Realm。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '批准后请从主屏幕返回 Cryptic Realm。如果 iOS 打开了浏览器，请将其关闭并重新打开主屏幕应用。',
  ...
  'wallet.browser.safety': 'Cryptic Realm 绝不会索要助记词或私钥。',
  ...
  'wallet.browser.completeBody': '现在可以返回 Cryptic Realm 桌面应用。',
  ...
  'playerCard.shareText':
    '我正在 Cryptic Realm 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  ...
  'seo.description':
    '在 Cryptic Realm 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 Cryptic Realm 的 GitHub 项目',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Cryptic Realm 勇士',
  ...
  'desktop.crash.fatalBody': 'Cryptic Realm 遇到意外错误，需要关闭。',
  ...
  'editor.docTitle': '地图编辑器 - Cryptic Realm',
  ...
  'entities.npcs.skirmish_builder.greeting': '斧头还是镐子，指挥官——指个方向就行。',
  'entities.npcs.skirmish_builder.name': '营地建造者',
  'entities.npcs.skirmish_builder.title': '战地营垒遭遇战',
  'entities.npcs.skirmish_footman.greeting': '给我指出匪帮的方向。',
  'entities.npcs.skirmish_footman.name': '营地步兵',
  'entities.npcs.skirmish_footman.title': '战地营垒遭遇战',
  'entities.npcs.skirmish_post.greeting': '营垒依然坚守。',
  'entities.npcs.skirmish_post.name': '营垒建筑',
  'entities.npcs.skirmish_post.title': '战地营垒遭遇战',
