...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Cryptic Realm 官方网站',
  'seo.officialBody':
    'crypticrealm.com 是 Claudemoon 服务器的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'wallet.balanceTitle': '已验证 Solana 钱包的 $CR 余额',
  'wallet.balanceAria': '已验证 Solana 钱包余额：{balance}',
  'wallet.balancePreviewTitle': '已连接钱包的 $CR 余额预览',
  ...
  'wallet.holderTiers.vaultwarden.flavor': '如今守护着真正的宝库：全部 $CR 的 0.01%。',
  ...
  'playerCard.defaultRealm': 'Cryptic Realm 世界',
  ...
  'playerCard.shareTierBit': '，{tier}级 $CR 持有者',
  'playerCard.shareText':
    '我正在 Cryptic Realm 中铸就传说：{level}级 {className}{tierBit}。加入我的服务器：',
  'playerCard.nativeShareTitle': 'Cryptic Realm 世界',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'Cryptic Realm：经典风格网页 MMO',
  'seo.description':
  ...
  'a11y.discordCommunity': '加入 Cryptic Realm 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 Cryptic Realm',
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 Cryptic Realm。',
  ...
  'mode.caLabel': '$CR 合约地址',
  'mode.caNote':
    'CR 是我们的社区代币。游玩游戏并不需要它。加入 Discord 一起讨论 CR 的用途与飞轮效应。',
  'mode.play': '开始游戏',
  'mode.playAria': '开始游玩 Cryptic Realm',
  ...
  'hudChrome.account.sectionWallet': '$CR 钱包',
  ...
  'guide.worldPage.intro':
    'Cryptic Realm 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。',
  ...
  'auth.hardcoreHint': '永久死亡。此角色一旦死亡将永久退役，无法再游玩。没有复活机会。',
  'auth.ladderChar': '天梯角色',
  'auth.ladderHint': '参与赛季天梯排名。赛季结束后将转换为普通角色（保留所有进度）。',
  'auth.ssoMoveweight': '使用 MoveWeight 登录',
  'auth.ssoProviders': '使用 Google、Facebook、Plex 或 Discord 继续',
  'hud.options.controller': '控制器',
  'hud.options.controllerDisconnected': '未连接',
  'hud.options.customization': '自定义',
  'hud.options.padAttackTarget': '攻击最近目标 · 选定目标',
  'hud.options.padCursorNote': '打开菜单、任务对话或聊天时，屏幕光标会自动启用——用摇杆移动，按 A 键点击（接受任务、发送聊天、使用菜单）。',
  'hud.options.padCursorToggle': '切换鼠标光标',
  'hud.options.padInteract': '互动 / 与NPC交谈',
  'hud.options.padJumpClick': '跳跃 · 光标模式下点击',
  'hud.options.padLeftStick': '左摇杆',
  'hud.options.padLookCursor': '视角 / 移动光标',
  'hud.options.padLtRt': 'LT / RT（按住）',
  'hud.options.padMenu': '打开游戏菜单',
  'hud.options.padRightStick': '右摇杆',
  'hud.options.padSkillChords': '按住 + A/B/X/Y 使用技能9–16',
  'hud.options.padSkills12': '技能 1 和 2',
  'hud.options.padSkills47': '技能 5–8',
  'hud.options.padStart': '开始 / 菜单',
  'hud.options.reportBug': '报告问题',
  'nav.contributions': '贡献',
  'nav.whitepaper': '白皮书',
  'realm.enter': '进入领域',
  'realm.exchangeNote': '交易所是唯一可以在各领域之间转移物品的领域。',
  'auth.ssoButton': '使用 Google、Facebook 或 Plex 继续',
  'hudChrome.account.sectionConnections': '关联账户',
  'hudChrome.account.connectionsSummary': '关联 Google、Facebook 或 Plex，即可用它们登录。',
  'hudChrome.account.ssoNotLinked': '未关联。',
  'hudChrome.account.ssoLinked': '已关联 — 你可以使用 Google、Facebook 或 Plex 登录。',
  'hudChrome.account.ssoLink': '关联 Google / Facebook / Plex',
  'hudChrome.account.ssoUnlink': '取消关联',
  'hudChrome.account.ssoLinkConflict': '该账户已关联到另一个 Cryptic Realm 登录。',
  'hudChrome.account.ssoUnlinkNeedsPassword': '请先设置密码 — SSO 目前是你唯一的登录方式。',
