...
<<<<<<< HEAD
  ...
  'download.linuxHint': 'AppImage：設為可執行後執行，無需安裝。',
  'download.windowsPending': 'Windows 版本待發布。',
  'nav.whitepaper': '白皮書',
  'nav.contributions': '貢獻',
=======
...
>>>>>>> v0.24.0
  ...
  'seo.officialBody':
    'crypticrealm.com 是 Claudemoon 伺服器的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
...
>>>>>>> v0.24.0
  ...
  'playerCard.shareText':
    '我正在 Cryptic Realm 中鑄就傳說：{level}級 {className}{tierBit}。加入我的伺服器：',
  ...
  'serverUnavailable.title': 'Cryptic Realm - 伺服器不可用',
