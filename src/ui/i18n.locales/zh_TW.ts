...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.options.controller": "手把",
  "hud.options.controllerDisconnected": "未連線",
  "hud.options.customization": "自訂",
  "hud.options.padAttackTarget": "攻擊最近 · 鎖定目標",
  "hud.options.padCursorNote": "當選單、任務對話框或聊天開啟時，螢幕游標會自動啟用——用搖桿移動並按 A 點擊（接受任務、傳送聊天、使用選單）。",
  "hud.options.padCursorToggle": "切換滑鼠游標",
  "hud.options.padInteract": "互動 / 與 NPC 對話",
  ...
  "hud.options.padSkillChords": "按住 + A/B/X/Y 使用技能 9–16",
  "hud.options.padSkills12": "技能 1 和 2",
  "hud.options.padSkills47": "技能 5–8",
  "hud.options.padStart": "Start / 選單",
  "hud.options.reportBug": "回報錯誤",
  ...
  "auth.ladderHint": "參與賽季天梯。賽季結束時轉為標準角色（保留全部進度）。",
  "auth.hardcoreChar": "硬核角色",
  "auth.hardcoreHint": "永久死亡。該角色一旦死亡將被永久退役，無法再次遊玩。沒有復活。",
  "auth.class": "職業",
  "auth.name": "名稱",
