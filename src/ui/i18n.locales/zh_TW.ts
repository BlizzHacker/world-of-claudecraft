...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hud.core.chatPlaceholder": "說點什麼...（/w 名字 密語，/r 回覆，/p 隊伍，/gu 公會，/o 幹部，/g 綜合）",
  ...
  "entities.abilities.cat_form.name": "獵豹形態",
  "entities.abilities.cat_form.description": "變形為獵豹：攻擊強度隨等級提高，攻擊使用能量和連擊點，產生的威脅值降低 29%。再次施放可返回施法者形態。",
  "entities.abilities.claw.name": "爪擊",
  "entities.abilities.claw.description": "用利爪攻擊敵人，造成武器傷害加 {damage}。獎勵 1 個連擊點。僅限獵豹形態。",
  "entities.abilities.ferocious_bite.name": "兇猛撕咬",
  "entities.abilities.ferocious_bite.description": "終結技，根據連擊點數造成傷害。僅限獵豹形態。",
  ...
  "entities.items.ogre_war_totem.name": "巨魔戰爭圖騰",
  ...
  "entities.items.ogre_bonecharm_staff.name": "巨魔骨符法杖",
  ...
  "entities.items.ogre_toe_ring.name": "巨魔趾環",
  ...
  "entities.quests.q_mistcaller.completion": "維爾死了，霧第一次散開。但他的遺言讓我血冷：Wyrm在群峰下甦醒。教派侍奉的東西比我們猜想的更古老，{playerName}。",
  "entities.quests.q_mistcaller.objectives.0.label": "擊敗喚霧者維爾",
  "entities.quests.q_highwatch_summons.title": "群峰守望",
  "entities.quests.q_highwatch_summons.text": "維爾的遺言仍在我耳邊，{playerName}：Wyrm在群峰下甦醒。取下高望召令，告訴瑟薩莉我隨後上山。",
  ...
  "entities.quests.q_ogre_totems.completion": "顱骨、獸皮...還有Wyrm鱗綁帶。這些圖騰是邪教送的禮，{playerName}。",
  ...
  "entities.quests.q_velkhar.completion": "維爾卡死了，儀式失去了頭。但你也感覺到了吧？靈魂已經耗盡，Wyrm不再沉睡。",
  "entities.quests.q_velkhar.objectives.0.label": "擊敗大死靈法師維爾卡",
  "entities.quests.q_gravewyrm.title": "墓龍科祖爾",
  "entities.quests.q_gravewyrm.text": "沒有儀式可阻止了，{playerName}，只剩半醒的Wyrm，吞食了谷地和濕地的死者。帶同伴進洞，完成我們從禮拜堂開始的事。",
  ...
  "mode.caNote": "$CR 是 Cryptic Realm 的 Solana SPL 代幣，用於遊戲功能、外觀、成就和帳號記錄，並非遊玩所需。",
  "mode.play": "開始遊戲",
