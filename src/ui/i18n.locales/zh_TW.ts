...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'mode.caNote': 'CR 是我們的社群代幣，並非遊玩所需。加入 Discord 一起討論 CR 的用途與飛輪效應。',
  'mode.play': '開始遊戲',
  ...
  'auth.hardcoreHint': '永久死亡。此角色一旦死亡將永久退役，無法再遊玩。沒有復活機會。',
  'auth.ladderChar': '天梯角色',
  'auth.ladderHint': '參與賽季天梯排名。賽季結束後將轉換為普通角色（保留所有進度）。',
  'auth.ssoMoveweight': '使用 MoveWeight 登入',
  'auth.ssoProviders': '使用 Google、Facebook、Plex 或 Discord 繼續',
  'hud.options.controller': '控制器',
  'hud.options.controllerDisconnected': '未連接',
  'hud.options.customization': '自訂',
  'hud.options.padAttackTarget': '攻擊最近目標 · 選定目標',
  'hud.options.padCursorNote': '開啟選單、任務對話或聊天時，螢幕游標會自動啟用——用搖桿移動，按 A 鍵點擊（接受任務、傳送聊天、使用選單）。',
  'hud.options.padCursorToggle': '切換滑鼠游標',
  'hud.options.padInteract': '互動 / 與NPC交談',
  'hud.options.padJumpClick': '跳躍 · 游標模式下點擊',
  'hud.options.padLeftStick': '左搖桿',
  'hud.options.padLookCursor': '視角 / 移動游標',
  'hud.options.padLtRt': 'LT / RT（按住）',
  'hud.options.padMenu': '開啟遊戲選單',
  'hud.options.padRightStick': '右搖桿',
  'hud.options.padSkillChords': '按住 + A/B/X/Y 使用技能9–16',
  'hud.options.padSkills12': '技能 1 和 2',
  'hud.options.padSkills47': '技能 5–8',
  'hud.options.padStart': '開始 / 選單',
  'hud.options.reportBug': '回報問題',
