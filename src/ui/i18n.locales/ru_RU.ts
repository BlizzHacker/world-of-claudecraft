...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.defaultRealm': 'Мир Cryptic Realm',
  ...
  'playerCard.nativeShareTitle': 'Мир Cryptic Realm',
  ...
  'mode.caNote':
    'CR - токен нашего сообщества. Он не нужен для игры. Присоединяйтесь к Discord, чтобы обсудить применение и экосистему CR.',
  'mode.play': 'Играть',
  ...
  'auth.hardcoreHint': 'Перманентная смерть. Если этот персонаж погибнет, он навсегда выбывает из игры и его больше нельзя будет использовать. Воскрешения нет.',
  'auth.ladderChar': 'Персонаж лиги',
  'auth.ladderHint': 'Участвует в сезонной лиге. По окончании сезона превращается в обычного персонажа (весь прогресс сохраняется).',
  'auth.ssoMoveweight': 'Войти через MoveWeight',
  'auth.ssoProviders': 'Продолжить через Google, Facebook, Plex или Discord',
  'hud.options.controller': 'Геймпад',
  'hud.options.controllerDisconnected': 'Не подключен',
  'hud.options.customization': 'Настройка',
  'hud.options.padAttackTarget': 'Атаковать ближайшую цель · выбор цели',
  'hud.options.padCursorNote': 'При открытии меню, диалога квеста или чата курсор на экране активируется автоматически — перемещайте его стиком и нажимайте A для клика (принятие квестов, отправка сообщений, работа с меню).',
  'hud.options.padCursorToggle': 'Переключить курсор мыши',
  'hud.options.padInteract': 'Взаимодействие / разговор с NPC',
  'hud.options.padJumpClick': 'Прыжок · клик в режиме курсора',
  'hud.options.padLeftStick': 'Левый стик',
  'hud.options.padLookCursor': 'Обзор / перемещение курсора',
  'hud.options.padLtRt': 'LT / RT (удерживать)',
  'hud.options.padMenu': 'Открыть игровое меню',
  'hud.options.padRightStick': 'Правый стик',
  'hud.options.padSkillChords': 'Удерживать + A/B/X/Y для навыков 9–16',
  'hud.options.padSkills12': 'Навыки 1 и 2',
  'hud.options.padSkills47': 'Навыки 5–8',
  'hud.options.padStart': 'Start / Меню',
  'hud.options.reportBug': 'Сообщить об ошибке',
