...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.stable_master_wren.greeting': 'Jeder Held braucht ein Reittier, $C. Der Hirsch ist verlässlich, der Raptor ist schnell, und der Wyrm... der Wyrm fliegt.',
