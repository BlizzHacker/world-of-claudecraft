...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.account.ssoLinked': 'Discord forbundet.',
  'hudChrome.account.ssoNotLinked': 'Discord ikke forbundet.',
  'hudChrome.account.ssoUnlink': 'Afbryd Discord',
  'hudChrome.account.ssoLinkConflict':
    'Den Discord-konto er allerede forbundet med en anden konto.',
  'hudChrome.account.ssoUnlinkNeedsPassword': 'Angiv en adgangskode for du afbryder Discord.',
  ...
  'playerCard.shareText':
    'Jeg smeder min legende i Cryptic Realm: Niveau {level} {className}{tierBit}. Slut dig til mit rige:',
  ...
  'seo.description':
    'Begiv dig ud på et episk eventyr i Cryptic Realm, en klassisk-inspireret micro-MMO, der kan spilles direkte i din browser. Slut dig til et vedvarende delt rige, lev op dine klasser, og besejr fjender!',
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'crypticrealm.com er den officielle gratis browser-MMO for Claudemoon-riget. Spil online med en vedvarende karakter, udforsk solo offline, læs wikien, og følg verificerede fællesskabslinks fra denne side.',
  ...
  'serverUnavailable.title': 'Cryptic Realm - Realm utilgængeligt',
