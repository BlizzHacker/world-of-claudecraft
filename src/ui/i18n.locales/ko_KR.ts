...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Cryptic Realm 공식 웹사이트',
  'seo.officialBody':
    'crypticrealm.com은 Cryptic Realm 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요.',
  ...
  'wallet.balanceTitle': '인증된 Solana 지갑 $CR 잔액',
  'wallet.balanceAria': '인증된 Solana 지갑 잔액: {balance}',
  'wallet.balancePreviewTitle': '연결된 지갑 $CR 잔액 미리보기',
  ...
  'wallet.standaloneAppHelp':
    '홈 화면 앱에서는 아직 지갑 연결을 사용할 수 없습니다. Phantom 또는 Solflare를 사용하려면 Safari나 Chrome에서 Cryptic Realm를 여세요.',
  ...
  'wallet.manualReturnStandaloneHelp':
    '승인 후 홈 화면에서 Cryptic Realm로 돌아오세요. iOS에서 브라우저가 열리면 닫고 홈 화면 앱을 다시 여세요.',
  ...
  'wallet.browser.safety': 'Cryptic Realm는 복구 문구나 개인 키를 요청하지 않습니다.',
  ...
  'wallet.browser.completeBody': 'Cryptic Realm 데스크톱 앱으로 돌아갈 수 있습니다.',
  ...
  'wallet.holder': '$CR 보유자',
  'wallet.holderTierTitle': '{tier} $CR 보유자',
  ...
  'wallet.holderTiers.vaultwarden.flavor': '이제 진짜 금고를 지킵니다: 전체 $CR의 0.01%.',
  ...
  'playerCard.shareTierBit': ', {tier} 등급 $CR 보유자',
  'playerCard.shareText':
    'Cryptic Realm에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 월드에 합류하세요:',
  ...
  'seo.title': 'Cryptic Realm: 클래식 스타일 웹 MMO',
  'seo.description':
    '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Cryptic Realm에서 장대한 모험을 시작하세요. 지속되는 공유 월드에 접속해 직업을 성장시키고 적을 물리치세요.',
  'seo.genre': 'MMORPG',
  'seo.playMode': '멀티플레이어',
  ...
  'a11y.githubProject': 'GitHub에서 Cryptic Realm 프로젝트 열기',
  'a11y.discordCommunity': 'Cryptic Realm Discord 커뮤니티 참여',
  'a11y.donateProject': 'Cryptic Realm 후원하기',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '새 홈 화면 아이콘에서 Cryptic Realm를 여세요.',
  ...
  'mobilePreflight.androidOpenStep': '새 아이콘에서 Cryptic Realm를 여세요.',
  ...
  'hudChrome.account.sectionWallet': '$CR 지갑',
  ...
  'guide.worldPage.intro':
    'Cryptic Realm는 두 발로 가로지르는 하나로 이어진 대지이며, 남에서 북으로 펼쳐진 세 개의 지역으로 이루어져 있습니다. 빠른 이동이 없으니, 여정 자체가 모험의 일부입니다.',
  ...
  'hudChrome.discord.swag.titleChampion': '칭호: Cryptic Realm의 챔피언',
  ...
  'hudChrome.nativeUpdate.body':
    'Cryptic Realm의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Cryptic Realm 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  ...
  'desktop.crash.fatalBody': 'Cryptic Realm에 예기치 않은 오류가 발생하여 종료해야 합니다.',
  ...
  'editor.docTitle': '맵 편집기 - Cryptic Realm',
  ...
  'entities.npcs.skirmish_builder.greeting': '도끼든 곡괭이든, 지휘관님 — 가리키기만 하십시오.',
  'entities.npcs.skirmish_builder.name': '군영 건설공',
  'entities.npcs.skirmish_builder.title': '워캠프 스커미시',
  'entities.npcs.skirmish_footman.greeting': '도적단이 어디인지 가리켜 주십시오.',
  'entities.npcs.skirmish_footman.name': '군영 보병',
  'entities.npcs.skirmish_footman.title': '워캠프 스커미시',
  'entities.npcs.skirmish_post.greeting': '군영은 버티고 있다.',
  'entities.npcs.skirmish_post.name': '군영 건조물',
  'entities.npcs.skirmish_post.title': '워캠프 스커미시',
