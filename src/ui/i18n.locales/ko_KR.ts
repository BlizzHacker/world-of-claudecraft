...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'crypticrealm.com은 Claudemoon 렐름의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요.',
  ...
  'playerCard.defaultRealm': 'Cryptic Realm의 세계',
  ...
  'playerCard.shareText':
    'Cryptic Realm에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 렐름에 합류하세요:',
  'playerCard.nativeShareTitle': 'Cryptic Realm의 세계',
  ...
  'serverUnavailable.title': 'Cryptic Realm - 렐름 이용 불가',
  ...
  'mode.caNote':
    'CR는 커뮤니티 토큰입니다. 플레이에는 필요하지 않습니다. CR의 활용과 선순환 구조에 관해 이야기하려면 Discord에 참여하세요.',
  'mode.play': '플레이',
  ...
  'auth.hardcoreChar': '하드코어 캐릭터',
  'auth.hardcoreHint': '영구 사망. 이 캐릭터가 죽으면 영구히 은퇴하며 더 이상 플레이할 수 없습니다. 부활은 없습니다.',
  'auth.ladderChar': '래더 캐릭터',
  'auth.ladderHint': '시즌 래더에서 경쟁합니다. 시즌 종료 시 일반 캐릭터로 전환됩니다 (모든 진행 상황 유지).',
  'auth.ssoMoveweight': 'MoveWeight로 로그인',
  'auth.ssoProviders': 'Google, Facebook, Plex 또는 Discord로 계속하기',
  'hud.options.controller': '컨트롤러',
  'hud.options.controllerDisconnected': '연결 안 됨',
  'hud.options.customization': '커스터마이징',
  'hud.options.padAttackTarget': '가장 가까운 대상 공격 · 타겟',
  'hud.options.padCursorNote': '메뉴, 퀘스트 대화상자 또는 채팅이 열리면 화면 커서가 자동으로 활성화됩니다 — 스틱으로 이동하고 A 버튼으로 클릭하세요 (퀘스트 수락, 채팅 전송, 메뉴 사용).',
  'hud.options.padCursorToggle': '마우스 커서 전환',
  'hud.options.padInteract': '상호작용 / NPC와 대화',
  'hud.options.padJumpClick': '점프 · 커서 모드에서 클릭',
  'hud.options.padLeftStick': '왼쪽 스틱',
  'hud.options.padLookCursor': '시점 / 커서 이동',
  'hud.options.padLtRt': 'LT / RT (누르고 있기)',
  'hud.options.padMenu': '게임 메뉴 열기',
  'hud.options.padRightStick': '오른쪽 스틱',
  'hud.options.padSkillChords': '누르고 + A/B/X/Y로 스킬 9-16',
  'hud.options.padSkills12': '스킬 1 & 2',
  'hud.options.padSkills47': '스킬 5-8',
  'hud.options.padStart': '시작 / 메뉴',
  'hud.options.reportBug': '버그 신고',
