...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.account.ssoNotLinked': 'Discord nao vinculado.',
  'hudChrome.account.ssoUnlink': 'Desvincular Discord',
  'hudChrome.account.ssoLinkConflict': 'Essa conta Discord ja esta vinculada a outra conta.',
  'hudChrome.account.ssoUnlinkNeedsPassword': 'Defina uma senha antes de desvincular Discord.',
  'news.officialLog': 'Registro oficial',
  'news.alphaBetaTitle': 'Cadencia alpha, beta e reino publico',
  'news.alphaBetaBody':
    'Testadores alpha ganham mais platina porque os personagens reiniciam a cada duas semanas. Beta promove mensalmente apos revisao.',
  'news.tokenTitle': 'Utilidade de $CR e platina',
  'news.tokenBody':
    '$CR e o token SPL Solana de Cryptic Realm. Platina conecta cosmeticos, casas, montarias, mercado e Exchange.',
  'news.prTitle': 'Trilha upstream',
  'news.prBody':
    'Melhorias genericas de motor, auth, paineis e wiki sao compartilhadas com ClaudeCraft; recursos de Cryptic Realm ficam aqui.',
  'news.proofTitle': 'Prova $CR',
  'news.proofBody': 'A pagina publica de prova mostra mint, tesouraria e links Solscan.',
  'news.openLink': 'Abrir',
  ...
  'auth.create': 'Criar',
  'auth.email': 'E-mail de recuperacao',
  'auth.emailPlaceholder': 'you@example.com',
  'auth.emailError': 'Informe um endereco de e-mail valido.',
  'auth.ssoMoveweight': 'Entrar com MoveWeight',
  'auth.ssoProviders': 'Continuar com Google, Facebook, Plex ou Discord',
  'auth.ssoButton': 'Continuar com Google, Facebook ou Plex',
  'auth.ladderChar': 'Personagem de temporada',
  'auth.ladderHint':
    'Compete na ladder sazonal. No fim da temporada, vira um personagem padrao e mantem todo o progresso.',
  'auth.hardcoreChar': 'Personagem hardcore',
  'auth.hardcoreHint':
    'Morte permanente. Se este personagem morrer, sera aposentado para sempre e nao podera mais ser jogado. Nao ha ressurreicao.',
