...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.crafting': 'Chế Tác',
  'abilityUi.cast.disenchanting': 'Hủy Pháp Khắc',
  'abilityUi.cast.enchanting_apply': 'Pháp Khắc',
  'abilityUi.cast.salvaging': 'Tháo Dỡ',
  'abilityUi.cast.tool_recharge': 'Nạp Lại',
  'auth.beard': 'Râu',
  'auth.beardChinpuff': 'Chòm Cằm',
  'auth.beardFull': 'Đầy Đủ',
  'auth.beardGoatee': 'Râu Dê',
  'auth.beardHorseshoe': 'Râu Móng Ngựa',
  'auth.beardMutton': 'Râu Mai',
  'auth.beardNone': 'Không Có',
  'auth.beardScruff': 'Râu Lởm Chởm',
  'auth.beardShortbox': 'Râu Vuông',
  'auth.beardStache': 'Ria Mép',
  'auth.beardStubble': 'Râu Lún Phún',
  'auth.beardStubbleBeard': 'Râu Lún Phún Dày',
  'auth.beardVikingb': 'Râu Tết Bím',
  'auth.beardWizard': 'Râu Pháp Sư',
  'auth.blush': 'Phấn Má',
  'auth.bodyChest': 'Ngực',
  'auth.bodyElbows': 'Khuỷu Tay',
  'auth.bodyFeet': 'Bàn Chân',
  'auth.bodyHands': 'Kích Thước Bàn Tay',
  'auth.bodyHips': 'Hông',
  'auth.bodyKnees': 'Đầu Gối',
  'auth.bodyShoulders': 'Vai',
  'auth.colorPresetAria': 'Cài đặt sẵn {label} {n}',
  'auth.customColor': 'Tùy Chỉnh',
  'auth.earBone': 'Bùa Xương',
  'auth.earBonehoop': 'Vòng Xương',
  'auth.earChain': 'Chuỗi Hạt Rủ',
  'auth.earCuff': 'Kẹp Tai',
  'auth.earFeather': 'Lông Vũ',
  'auth.earHoop': 'Vòng Tròn',
  'auth.earMoon': 'Trăng Lưỡi Liềm',
  'auth.earMoonstar': 'Sao Dưới Trăng',
  'auth.earNone': 'Không Có',
  'auth.earRunic': 'Đá Phù Văn',
  'auth.earSeptum': 'Khuyên Mũi',
  'auth.earStud': 'Khuyên Đính',
  'auth.earWarden': 'Sắt Hộ Vệ',
  'auth.earrings': 'Khuyên Tai',
  'auth.eyeshadow': 'Phấn Mắt',
  'auth.hairAfro': 'Tóc Afro Tròn',
  'auth.hairAsymbob': 'Tóc Bob Bất Đối Xứng',
  'auth.hairBluntbangs': 'Tóc Bob Mái Bằng',
  'auth.hairBraidcrown': 'Tóc Tết Vương Miện',
  'auth.hairBuzz': 'Tóc Cắt Sát',
  'auth.hairChinbob': 'Tóc Bob Ngang Cằm',
  'auth.hairCrew': 'Tóc Đầu Đinh',
  'auth.hairCrewcut': 'Tóc Đầu Đinh Tạo Kiểu',
  'auth.hairCurls': 'Tóc Xoăn Buông Lơi',
  'auth.hairCurlyafro': 'Tóc Afro Xoăn',
  'auth.hairCurlycap': 'Tóc Xoăn Ngắn Ôm Đầu',
  'auth.hairCurtains': 'Tóc Rẽ Giữa Kiểu Rèm',
  'auth.hairFantasybraid': 'Tóc Tết Huyền Ảo',
  'auth.hairFauxhawk': 'Tóc Mohawk Giả',
  'auth.hairHalfbun': 'Tóc Búi Nửa Đầu',
  'auth.hairHighbun': 'Tóc Búi Cao',
  'auth.hairHighpony': 'Tóc Đuôi Ngựa Cao',
  'auth.hairLayered': 'Tóc Tỉa Lớp Ngang Vai',
  'auth.hairLongcenterpart': 'Tóc Dài Rẽ Giữa',
  'auth.hairLongpart': 'Tóc Dài Thẳng Rẽ Giữa',
  'auth.hairLongwavy': 'Tóc Dài Gợn Sóng',
  'auth.hairLowbun': 'Tóc Búi Thấp',
  'auth.hairLowpony': 'Tóc Đuôi Ngựa Thấp',
  'auth.hairMessy': 'Tóc Gai Ngắn Bù Xù',
  'auth.hairMohawk': 'Tóc Mohawk Đầy Đủ',
  'auth.hairMullet': 'Tóc Mullet Bản Dày',
  'auth.hairPixie': 'Tóc Pixie',
  'auth.hairPompadour': 'Tóc Pompadour Ngắn',
  'auth.hairQuiff': 'Tóc Quiff Hất Ngược',
  'auth.hairSidepart': 'Tóc Rẽ Ngôi Bên Cổ Điển',
  'auth.hairSidepony': 'Tóc Đuôi Ngựa Lệch',
  'auth.hairSweptback': 'Tóc Vuốt Ngược Vừa',
  'auth.hairSweptpixie': 'Tóc Pixie Vuốt Nghiêng',
  'auth.hairTopknot': 'Tóc Búi Đỉnh Đầu',
  'auth.hairTwinbraids': 'Tóc Tết Đôi',
  'auth.hairWarriorbraid': 'Tóc Tết Chiến Binh',
  'auth.hairWavybob': 'Tóc Bob Gợn Sóng',
  'auth.helmPreview': 'Hiện Mũ Giáp',
  'auth.jewelAmethyst': 'Thạch Anh Tím',
  'auth.jewelBone': 'Xương',
  'auth.jewelBronze': 'Đồng Thau',
  'auth.jewelCopper': 'Đồng',
  'auth.jewelDefault': 'Nguyên Bản',
  'auth.jewelGold': 'Vàng',
  'auth.jewelIron': 'Sắt',
  'auth.jewelJade': 'Ngọc Bích',
  'auth.jewelMaterial': 'Chất Liệu Trang Sức',
  'auth.jewelObsidian': 'Hắc Diện Thạch',
  'auth.jewelPearl': 'Ngọc Trai',
  'auth.jewelRuby': 'Hồng Ngọc',
  'auth.jewelSilver': 'Bạc',
  'auth.jewelTurquoise': 'Ngọc Lam',
  'auth.lashColor': 'Màu Lông Mi',
  'auth.lashes': 'Lông Mi',
  'auth.lashesOff': 'Tắt',
  'auth.lashesOn': 'Bật',
  'auth.lipstick': 'Son Môi',
  'auth.makeupNone': 'Không Có',
  'auth.outfit': 'Màu Trang Phục',
  'auth.outfitAzure': 'Xanh Lam',
  'auth.outfitBloodforged': 'Huyết Rèn',
  'auth.outfitBonewrought': 'Cốt Rèn',
  'auth.outfitClassic': 'Cổ Điển',
  'auth.outfitCrimson': 'Đỏ Thẫm',
  'auth.outfitEmber': 'Than Hồng',
  'auth.outfitEmerald': 'Ngọc Lục Bảo',
  'auth.outfitForest': 'Xanh Rừng',
  'auth.outfitGilded': 'Mạ Vàng',
  'auth.outfitGold': 'Vàng',
  'auth.outfitIvory': 'Ngà',
  'auth.outfitMagenta': 'Hồng Cánh Sen',
  'auth.outfitObsidian': 'Hắc Diện Thạch',
  'auth.outfitOnyx': 'Mã Não',
  'auth.outfitRose': 'Hồng',
  'auth.outfitRoyal': 'Xanh Hoàng Gia',
  'auth.outfitTeal': 'Xanh Mòng Két',
  'auth.outfitVerdigris': 'Xanh Gỉ Đồng',
  'auth.outfitViolet': 'Tím',
  'auth.randomize': 'Ngẫu Nhiên Diện Mạo',
  'auth.randomizeShort': 'Ngẫu Nhiên',
  'auth.resetLook': 'Đặt Lại Diện Mạo',
  'auth.resetShort': 'Đặt Lại',
  'auth.shadeBerry': 'Dâu',
  'auth.shadeBronze': 'Đồng Thau',
  'auth.shadeCoral': 'San Hô',
  'auth.shadeMauve': 'Tím Nhạt',
  'auth.shadeNude': 'Nude',
  'auth.shadePeach': 'Đào',
  'auth.shadePlum': 'Mận',
  'auth.shadeRose': 'Hồng',
  'auth.shadeRuby': 'Hồng Ngọc',
  'auth.shadeSmoke': 'Khói',
  'auth.shadeTeal': 'Xanh Mòng Két',
  'auth.shadeWarm': 'Ấm',
  'auth.style': 'Kiểu Dáng',
  'editor.status.campCapReached': 'Đã đạt giới hạn Trại Quái ({max}). Trại mới không được thêm vào.',
  'entities.itemSets.warfare_ashstalker.bonus2': 'Tăng Chỉ Số Phòng Thủ CHIẾN TRANH thêm 40.',
  'entities.itemSets.warfare_ashstalker.bonus4': 'Tăng Chỉ Số Tấn Công CHIẾN TRANH thêm 40, và hiệu ứng khống chế do người chơi thù địch gây lên bạn kéo dài ngắn hơn 15%.',
  'entities.itemSets.warfare_ashstalker.bonus7': 'Tăng Chỉ Số Tấn Công và Phòng Thủ CHIẾN TRANH thêm 80. Hạ gục một người chơi thù địch ban Bước Chân Tro Tàn, tăng tốc độ di chuyển thêm 40% trong 6 giây.',
  'entities.itemSets.warfare_ashstalker.name': 'Bộ Ashstalker',
  'entities.itemSets.warfare_cinderweave.bonus2': 'Tăng Chỉ Số Phòng Thủ CHIẾN TRANH thêm 40.',
  'entities.itemSets.warfare_cinderweave.bonus4': 'Tăng Chỉ Số Tấn Công CHIẾN TRANH thêm 40, và hiệu ứng khống chế do người chơi thù địch gây lên bạn kéo dài ngắn hơn 15%.',
  'entities.itemSets.warfare_cinderweave.bonus7': 'Tăng Chỉ Số Tấn Công và Phòng Thủ CHIẾN TRANH thêm 80. Phép của bạn có 15% cơ hội ban Vệ Than Hồng, hấp thụ 120 sát thương trong 8 giây.',
  'entities.itemSets.warfare_cinderweave.name': 'Lễ Phục Cinderweave',
  'entities.itemSets.warfare_furyforged.bonus2': 'Tăng Chỉ Số Phòng Thủ CHIẾN TRANH thêm 40.',
  'entities.itemSets.warfare_furyforged.bonus4': 'Tăng Chỉ Số Tấn Công CHIẾN TRANH thêm 40, và hiệu ứng khống chế do người chơi thù địch gây lên bạn kéo dài ngắn hơn 15%.',
  'entities.itemSets.warfare_furyforged.bonus7': 'Tăng Chỉ Số Tấn Công và Phòng Thủ CHIẾN TRANH thêm 80. Hạ gục một người chơi thù địch ban Lời Thề Bất Diệt, hấp thụ 200 sát thương trong 10 giây.',
  'entities.itemSets.warfare_furyforged.name': 'Bộ Chiến Furyforged',
  'entities.itemSets.warfare_stormbound.bonus2': 'Tăng Chỉ Số Phòng Thủ CHIẾN TRANH thêm 40.',
  'entities.itemSets.warfare_stormbound.bonus4': 'Tăng Chỉ Số Tấn Công CHIẾN TRANH thêm 40, và hiệu ứng khống chế do người chơi thù địch gây lên bạn kéo dài ngắn hơn 15%.',
  'entities.itemSets.warfare_stormbound.bonus7': 'Tăng Chỉ Số Tấn Công và Phòng Thủ CHIẾN TRANH thêm 80. Phép của bạn có 15% cơ hội ban Vệ Than Hồng, hấp thụ 120 sát thương trong 8 giây.',
  'entities.itemSets.warfare_stormbound.name': 'Áo Lễ Stormbound',
  'entities.itemSets.warfare_thornhide.bonus2': 'Tăng Chỉ Số Phòng Thủ CHIẾN TRANH thêm 40.',
  'entities.itemSets.warfare_thornhide.bonus4': 'Tăng Chỉ Số Tấn Công CHIẾN TRANH thêm 40, và hiệu ứng khống chế do người chơi thù địch gây lên bạn kéo dài ngắn hơn 15%.',
  'entities.itemSets.warfare_thornhide.bonus7': 'Tăng Chỉ Số Tấn Công và Phòng Thủ CHIẾN TRANH thêm 80. Phép của bạn có 15% cơ hội ban Vệ Gai, tăng né tránh thêm 15% trong 6 giây.',
  'entities.itemSets.warfare_thornhide.name': 'Trang Phục Thornhide',
  'entities.items.curved_tusk.name': 'Ngà Cong',
  'entities.items.pristine_claw.name': 'Móng Vuốt Nguyên Vẹn',
  'entities.items.sharp_claw.name': 'Móng Vuốt Sắc Nhọn',
  'entities.items.thornhide_boots.name': 'Giày Thornhide',
  'entities.items.thornhide_cinch.name': 'Đai Lưng Thornhide',
  'entities.items.thornhide_gloves.name': 'Găng Tay Thornhide',
  'entities.items.thornhide_headdress.name': 'Mũ Thornhide',
  'entities.items.thornhide_leggings.name': 'Quần Giáp Thornhide',
  'entities.items.thornhide_mantle.name': 'Áo Choàng Thornhide',
  'entities.items.thornhide_vestment.name': 'Y Phục Thornhide',
  'entities.npcs.warmarshal_draven_kole.greeting': 'Danh dự là đồng tiền duy nhất ta nhận, và các kho Chiến Tranh là của ta để canh giữ. Hãy lập cấp bậc của ngươi trên chiến trường, và ta sẽ trang bị cho ngươi để bước vào trận tiếp theo.',
  'entities.npcs.warmarshal_draven_kole.name': 'Chiến Thống Chế Draven Kole',
  'entities.npcs.warmarshal_draven_kole.title': 'Quân Nhu Trưởng Chiến Tranh',
  'guide.controls.dungeonFinder': 'Tìm Hầm Ngục',
  'guide.controls.mount': 'Cưỡi Thú / Xuống Thú',
  'guide.controls.professions': 'Nghề Nghiệp',
  'guide.controls.sheathe': 'Tra/Rút Vũ Khí',
  'guide.controls.targetAuras': 'Chọn buff và debuff mục tiêu',
  'guide.gear.uniqueBody': 'Vật phẩm huyền thoại là độc nhất khi trang bị: nhân vật của bạn chỉ có thể mặc một bản duy nhất của một huyền thoại nhất định tại một thời điểm, và phiên bản Anh Hùng của nó được tính là cùng một vật phẩm. Một bản thứ hai có thể nằm trong túi đồ, trong ngân hàng, hoặc trên chợ của bạn, nhưng cố mặc cả hai cùng lúc sẽ bị từ chối, và chú thích mang một nhãn Độc Nhất Khi Trang Bị màu vàng để bạn biết luật này trước khi lên kế hoạch xây dựng nhân vật quanh hai món đó.',
  'guide.gear.uniqueTitle': 'Độc Nhất Khi Trang Bị: mỗi loại huyền thoại một món',
  'guide.nav.thornhollow': 'Cánh Đồng Trũng Gai',
  'guide.profPages.econ.castPaceBatch': 'Chế tác theo mẻ: tối đa {count} trong một đơn hàng, mỗi món một lượt thi triển',
  'guide.profPages.econ.castPaceBody': 'Hành động nghề nghiệp tốn thời gian thi triển thực sự: công thức trải dài từ chưa đầy hai giây cho việc dã chiến đơn giản đến vài giây ở đỉnh thang, và hủy pháp khắc, pháp khắc, tháo dỡ, và nạp lại hiệu ứng công cụ mỗi loại đều tốn một lượt thi triển ngắn cố định. Hủy giữa chừng và bạn không mất gì cả. Mỗi lần chế tác thành công cũng trả một khoản phí đồng tỷ lệ với ngân sách vật phẩm. Cùng với nguyên liệu, trạm chế tác, và trần kỹ năng, nhịp độ đó giữ cho Chợ luôn trung thực mà không cần một hạn ngạch hành động riêng. Thời lượng chính xác theo từng dải kỹ năng được liệt kê bên dưới.',
  'guide.profPages.econ.castPaceCombo': 'Công thức đỉnh thang và công thức kết hợp: thi triển {seconds} giây',
  'guide.profPages.econ.castPaceEnchantFamily': 'Hủy pháp khắc, pháp khắc, và tháo dỡ: thi triển {seconds} giây',
  'guide.profPages.econ.castPaceField': 'Công thức dã chiến (không yêu cầu kỹ năng): thi triển {seconds} giây',
  'guide.profPages.econ.castPaceHeading': 'Thời gian thi triển và kênh tiêu vàng',
  'guide.profPages.econ.castPaceRecharge': 'Nạp lại hiệu ứng công cụ: thi triển {seconds} giây',
  'guide.profPages.econ.castPaceSkill25': 'Công thức đến kỹ năng 25: thi triển {seconds} giây',
  'guide.profPages.econ.castPaceSkill50': 'Công thức đến kỹ năng 50: thi triển {seconds} giây',
  'guide.profPages.econ.castPaceSkill75': 'Công thức đến kỹ năng 75: thi triển {seconds} giây',
  'guide.profPages.fish.earlyReelNote': 'Một lưu ý cho những ngón tay vội vàng: nhấn cần câu lần nữa trước khi có gì cắn câu và bạn sẽ giật lên một sợi dây trống, kết thúc lượt thả câu (một khoảnh khắc ân hạn ngay sau khi thả câu sẽ bỏ qua một lần nhấn đúp vô tình). Kiên nhẫn là cả trò chơi: chờ cá cắn câu, rồi ra tay.',
  'guide.thornhollowPage.carrierBody': 'Người mang cờ giữ cờ địch quá lâu sẽ ngày càng dễ tổn thương, nhận sát thương tăng dần cho đến khi cờ được chiếm, bị rơi, hoặc được trả về. Trốn cùng lá cờ là một kế hoạch thua cuộc; chạy mang nó về nhà mới là cách để thắng.',
  'guide.thornhollowPage.carrierHeading': 'Mang cờ',
  'guide.thornhollowPage.fieldBody': 'Một chiến trường ngoài trời có tường bao, chia thành ba khoang: mỗi đội có sân riêng trước pháo đài của mình, và Sân Phế Tích có tường bao nằm giữa chúng. Hai bức tường thành trải dài toàn bộ chiều rộng, và mỗi lần di chuyển giữa các khoang đều phải qua một điểm giao tranh: cổng chính rộng, hoặc nhà gác cổng, một căn phòng nhỏ vắt ngang tường với những cánh cửa lệch nhau buộc người chơi phải vòng qua một góc phục kích. Mỗi pháo đài đều được bịt kín trừ lối vào của nó, nên mọi cuộc chạy cờ đều bắt đầu và kết thúc qua cùng một lối mở, và một chướng ngại vật thấp phá vỡ đường xông thẳng vào đó. Sân trong giữ phế tích trái tim rỗng và hai Phù Văn Tăng Tốc ở hai bên sườn; hai cái còn lại chờ trên các lối tiếp cận cờ. Một Phù Văn Chiến Đấu hoặc Phù Văn Phòng Thủ (gây thêm sát thương, hoặc nhận ít sát thương hơn, trong vài giây) chờ ở lối vào sân trong của mỗi cổng chính: cả hai bệ đều mở trận trên cùng một mặt và đổi phe mỗi khi có người chiếm được.',
  'guide.thornhollowPage.fieldHeading': 'Chiến trường',
  'guide.thornhollowPage.flagsBody': 'Mỗi pháo đài giữ lá cờ đội mình. Cướp cờ địch và mang nó về bệ cờ của bạn để ghi điểm; đội đầu tiên đạt ba lần chiếm cờ sẽ thắng, và một trận hết giờ sẽ được phân định theo điểm số. Người mang cờ bị hạ sẽ làm rơi cờ tại nơi họ ngã xuống: kẻ địch có thể nhặt nó lên lần nữa, trong khi chính đội của lá cờ đó chỉ cần chạm tới là trả nó về nhà ngay lập tức. Lá cờ cũng từ chối ẩn nấp: nhặt nó lên sẽ phá vỡ ẩn thân, và người mang cờ tàng hình bằng bất kỳ cách nào cũng sẽ làm rơi cờ ngay tại chỗ.',
  'guide.thornhollowPage.flagsHeading': 'Cờ',
  'guide.thornhollowPage.heading': 'Cánh Đồng Trũng Gai',
  'guide.thornhollowPage.intro': 'Một chiến trường cướp cờ xếp hạng 5 đấu 5 diễn ra trong một thung lũng có tường bao giữa cánh rừng già dưới chân Đỉnh Gai, nơi hai pháo đài đổ nát đối mặt nhau dọc theo chiều dài một khe núi và một sân trong cổ xưa hơn nằm giữa chúng mà chưa bên nào từng chiếm được. Hai đội năm người, hai pháo đài, một mục tiêu: cướp lấy cờ địch và mang nó về nhà trước khi họ mang được cờ của bạn về.',
  'guide.thornhollowPage.ladderBody': 'Mỗi trận đấu đều làm thay đổi một chỉ số xếp hạng chiến trường bền vững theo từng nhân vật, dù thắng hay thua, và bảng xếp hạng mọi thời đại xếp hạng các Nhà Vô Địch của vương quốc. Chiến thắng và cả những thất bại chiến đấu ngoan cường cũng trả Danh dự qua hệ thống Chiến Tranh.',
  'guide.thornhollowPage.ladderHeading': 'Bảng xếp hạng',
  'guide.thornhollowPage.pickupNote': 'Nhặt cờ lên luôn là một lần nhấn có chủ ý phím hành động chiến trường: không ai từng trở thành người mang cờ chỉ vì né ngang qua nhầm chỗ.',
  'guide.thornhollowPage.queueBody': 'Mở bảng Cánh Đồng Trũng Gai và vào hàng chờ một mình, hoặc dẫn theo một nhóm tối đa năm người và xếp hàng cùng nhau: các nhóm luôn được giữ chung một đội, và những chỗ còn lại được lấp đầy bằng các Nhà Vô Địch đi một mình. Khi đủ mười người sẵn sàng, trận đấu xếp cả hai đội vào pháo đài của họ để tập hợp trong chốc lát trước khi cờ được kích hoạt.',
  'guide.thornhollowPage.queueHeading': 'Vào hàng chờ',
  'guide.thornhollowPage.respawnBody': 'Cái chết vẫn giữ nghi thức cổ điển: thi thể bạn nằm lại nơi nó ngã xuống cho đến khi CHÍNH BẠN giải thoát, và linh hồn trỗi dậy tại nghĩa địa có rào cạnh pháo đài của bạn, được bảo vệ ở đó cho tới đợt hồi sinh tiếp theo của đội bạn. Đợt hồi sinh đánh thức mọi linh hồn đang chờ cùng một lúc, và hai đợt hồi sinh của hai đội được cố ý lệch nhịp nhau, để trận đấu không bao giờ hoàn toàn tái lập cùng một lúc. Không có màn chạy xác và không có giao kèo với Người Canh Giữ Nhợt Nhạt: giải thoát, chờ hết đợt, rồi chiến đấu.',
  'guide.thornhollowPage.respawnHeading': 'Ngã xuống trong trận đấu',
  'hud.combat.blockedDone': '{ability} của bạn bị {target} đỡ, gây {amount} sát thương.',
  'hud.combat.blockedTaken': 'Bạn đỡ đòn tấn công của {source}, nhận {amount} sát thương.',
  'hud.combat.floatingBlock': '{amount} Đỡ Đòn',
  'hud.keybinds.actions.arena': 'Đấu Trường (Ashen Coliseum)',
  'hudChrome.auraEffect.carriedFlag': 'Bạn đang mang cờ địch. Hủy hiệu ứng này để thả nó xuống.',
  'hudChrome.bank.guildReadOnlyNote': 'Chỉ sĩ quan bang hội mới có thể thay đổi ngân hàng bang hội.',
  'hudChrome.bank.guildUnopenedNote': 'Ngân hàng bang hội chưa được mở.',
  'hudChrome.bank.logUnavailable': 'Không thể đọc nhật ký ngân hàng bang hội lúc này.',
  'hudChrome.bg.azure': 'Xanh Lam',
  'hudChrome.bg.blurb': 'Hai pháo đài đổ nát đối mặt nhau qua một thung lũng có tường bao dưới bóng Đỉnh Gai: Đỏ Thẫm ở phía nam, Xanh Lam ở phía bắc, và Sân Phế Tích cổ xưa hơn nằm giữa chúng mà chưa bên nào từng chiếm được. Năm người mỗi bên, mỗi bên một lá cờ, và bên đầu tiên mang được ba lá cờ của đối phương về nhà sẽ giành lấy chiến trường.',
  'hudChrome.bg.board.assists': 'Hỗ Trợ',
  'hudChrome.bg.board.captures': 'Chiếm Cờ',
  'hudChrome.bg.board.deaths': 'Tử Trận',
  'hudChrome.bg.board.kills': 'Hạ Gục',
  'hudChrome.bg.boardToggleLabel': 'Bảng điểm trận đấu. Nhấn Enter để ghim bảng đầy đủ luôn mở.',
  'hudChrome.bg.capturedLog': '{name} đã chiếm được cờ {team}. Tỷ số {crimson}:{azure}.',
  'hudChrome.bg.capturedTeamBanner': '{takers} đã chiếm được cờ {team}! {crimson}:{azure}',
  'hudChrome.bg.careerCaptures': 'Số lần chiếm cờ trong sự nghiệp: {count}',
  ...
  'hudChrome.bg.dropFlagConfirmTitle': 'Thả cờ?',
  'hudChrome.bg.endBannerDetail': 'Cánh Đồng Trũng Gai {crimson}:{azure}. Xếp hạng {rating} ({delta})',
  'hudChrome.bg.endLog': 'Cánh Đồng Trũng Gai kết thúc {crimson}:{azure}. Xếp hạng {rating} ({delta}).',
  'hudChrome.bg.endedForfeit': 'Trận đấu đã bị bỏ cuộc',
  'hudChrome.bg.endedForfeitLog': 'Trận đấu đã bị bỏ cuộc.',
  'hudChrome.bg.endedTimer': 'Hết giờ',
  'hudChrome.bg.endedTimerLog': 'Đồng hồ trận đấu đã hết giờ; đội có điểm cao hơn giành lấy chiến trường.',
  'hudChrome.bg.enterQueue': 'Vào Hàng Chờ',
  'hudChrome.bg.enterQueueParty': 'Vào Hàng Chờ (nhóm {count} người)',
  'hudChrome.bg.firstTo': 'Đầu tiên đạt {caps} lần chiếm cờ',
  'hudChrome.bg.firstWinBonusLine': 'Chiến thắng đầu tiên trong ngày: +{honor} Danh dự',
  'hudChrome.bg.firstWinBonusLog': 'Chiến thắng đầu tiên trong ngày: bạn nhận thêm {honor} Danh dự thưởng.',
  'hudChrome.bg.flagDroppedLog': 'Cờ {team} đã rơi xuống đất.',
  'hudChrome.bg.flagReturnedBanner': 'Cờ {team} đã được trả về!',
  'hudChrome.bg.flagReturnedLog': 'Cờ {team} đã được trả về.',
  'hudChrome.bg.flagState.carried': 'Cờ đã bị cướp!',
  'hudChrome.bg.flagState.dropped': 'Cờ đang ở dưới đất',
  'hudChrome.bg.flagState.home': 'Cờ tại pháo đài',
  'hudChrome.bg.flagTakenBanner': '{takers} đã cướp được cờ {team}!',
  'hudChrome.bg.flagTakenLog': '{name} đã cướp được cờ {team}!',
  'hudChrome.bg.formUp': 'Tập hợp: {seconds}',
  'hudChrome.bg.foundBanner': 'Đã tìm thấy trận đấu. Bạn chiến đấu cho {team}!',
  'hudChrome.bg.killFeed': '{killer} đã hạ {victim}',
  'hudChrome.bg.killFeedFallen': '{victim} đã ngã xuống',
  'hudChrome.bg.ladderAllTime': 'Bảng Xếp Hạng. Mọi Thời Đại',
  'hudChrome.bg.ladderOnline': 'Bảng Xếp Hạng. Đang Trực Tuyến',
  'hudChrome.bg.leaveQueue': 'Rời Hàng Chờ',
  'hudChrome.bg.leavingIn': 'Rời chiến trường sau {seconds}',
  'hudChrome.bg.levelRequirement': 'Bạn phải đạt cấp {level} để mở khóa xếp hàng cho chiến trường này.',
  'hudChrome.bg.map.azureKeep': 'Pháo Đài Xanh Lam',
  'hudChrome.bg.map.crimsonKeep': 'Pháo Đài Đỏ Thẫm',
  'hudChrome.bg.map.graveyard': 'Nghĩa Địa',
  'hudChrome.bg.map.ruinCourtyard': 'Sân Phế Tích',
  'hudChrome.bg.matchInProgress': 'Trận đấu đang diễn ra. {crimson}:{azure}.',
  'hudChrome.bg.modeTag': '5 đấu 5 Cướp Cờ',
  'hudChrome.bg.noChallengers': 'Hiện không có Nhà Vô Địch nào trực tuyến. Hãy là người đầu tiên.',
  'hudChrome.bg.noRanked': 'Chưa có Nhà Vô Địch nào được xếp hạng. Hãy là người đầu tiên.',
  'hudChrome.bg.offlineNote': 'Cánh Đồng Trũng Gai đang đồng bộ. Hàng chờ sẽ mở khi thế giới phản hồi.',
  ...
  'hudChrome.bg.resultVictory': 'Chiến Thắng!',
  'hudChrome.bg.searching': 'Đang tìm trận. {count}/{size} trong hàng chờ.',
  'hudChrome.bg.startBanner': 'Cướp cờ!',
  'hudChrome.bg.timeWarningMinutes': 'Còn lại {minutes} phút',
  'hudChrome.bg.timeWarningMinutesLog': 'Còn lại {minutes} phút trong trận đấu.',
  'hudChrome.bg.timeWarningOneMinute': 'Còn lại một phút',
  'hudChrome.bg.timeWarningOneMinuteLog': 'Còn lại một phút trong trận đấu.',
  'hudChrome.bg.title': 'Cánh Đồng Trũng Gai',
  'hudChrome.bg.victoryBanner': 'Chiến thắng! Cánh Đồng Trũng Gai {crimson}:{azure}. Xếp hạng {rating} ({delta})',
  'hudChrome.bg.yourTeamTitle': 'Đội của bạn',
  'hudChrome.commissionBoard.acceptButton': 'Chấp Nhận',
  'hudChrome.commissionBoard.accepted': 'Bạn chấp nhận đơn ủy thác cho {item}.',
  'hudChrome.commissionBoard.acceptedBy': 'Được {name} chấp nhận',
  'hudChrome.commissionBoard.boardEmpty': 'Hiện không có đơn nào đang mở.',
  'hudChrome.commissionBoard.cancelButton': 'Hủy',
  'hudChrome.commissionBoard.cancelled': 'Bạn hủy đơn ủy thác cho {item}.',
  'hudChrome.commissionBoard.close': 'Đóng bảng đơn ủy thác',
  'hudChrome.commissionBoard.crafterNameLabel': 'Tên thợ chế tác',
  'hudChrome.commissionBoard.crafterNamePlaceholder': 'Tên nhân vật',
  'hudChrome.commissionBoard.deliverButton': 'Giao Hàng',
  'hudChrome.commissionBoard.deliverHint': 'Chế tác món đồ ủy thác (bật công tắc ủy thác), rồi quay lại đây để giao nó.',
  'hudChrome.commissionBoard.delivered': 'Bạn giao {item} cho {name}.',
  'hudChrome.commissionBoard.denyNoSpace': 'Người yêu cầu không còn chỗ trống trong túi đồ.',
  'hudChrome.commissionBoard.denyNotCommissionEligible': 'Công thức đó không thể được ủy thác.',
  'hudChrome.commissionBoard.denyNotCrafted': 'Hãy chế tác món đồ ủy thác trước (bật công tắc ủy thác).',
  'hudChrome.commissionBoard.denyNotEligibleCrafter': 'Đơn ủy thác đó được đăng cho người khác.',
  'hudChrome.commissionBoard.denyNotYourAcceptance': 'Bạn chưa chấp nhận đơn ủy thác đó.',
  'hudChrome.commissionBoard.denyNotYourOrder': 'Đó không phải đơn ủy thác của bạn.',
  'hudChrome.commissionBoard.denyOrderNotAccepted': 'Đơn ủy thác đó chưa được chấp nhận.',
  'hudChrome.commissionBoard.denyOrderNotOpen': 'Đơn ủy thác đó không còn mở nữa.',
  'hudChrome.commissionBoard.denyOutOfRange': 'Bạn phải ở gần người yêu cầu để giao đồ ủy thác.',
  'hudChrome.commissionBoard.denySelfCrafter': 'Bạn không thể tự ủy thác cho chính mình.',
  'hudChrome.commissionBoard.denySelfOrder': 'Bạn không thể chấp nhận đơn ủy thác của chính mình.',
  'hudChrome.commissionBoard.denyTooManyOpen': 'Bạn đã có quá nhiều đơn ủy thác đang mở.',
  'hudChrome.commissionBoard.denyUnknownCrafter': 'Không tìm thấy nhân vật nào có tên đó.',
  'hudChrome.commissionBoard.denyUnknownOrder': 'Đơn ủy thác đó không còn tồn tại.',
  'hudChrome.commissionBoard.denyUnknownRecipe': 'Công thức đó không tồn tại.',
  'hudChrome.commissionBoard.formTitle': 'Mở Đơn Ủy Thác',
  'hudChrome.commissionBoard.intro': 'Ủy thác cho một thợ chế tác làm một món đồ cho bạn, hoặc nhận đơn của người khác.',
  'hudChrome.commissionBoard.mineEmpty': 'Bạn chưa mở đơn ủy thác nào.',
  'hudChrome.commissionBoard.openButton': 'Đơn Hàng',
  'hudChrome.commissionBoard.openButtonAria': 'Mở bảng đơn ủy thác',
  'hudChrome.commissionBoard.openSubmit': 'Đăng Đơn',
  'hudChrome.commissionBoard.opened': 'Bạn đăng một đơn ủy thác cho {item}.',
  'hudChrome.commissionBoard.recipeEmpty': 'Bạn chưa biết công thức trang bị nào có thể chế tạo.',
  'hudChrome.commissionBoard.recipeLabel': 'Vật Phẩm',
  'hudChrome.commissionBoard.rowFor': '{item} cho {requester}',
  'hudChrome.commissionBoard.rowTargeted': '{item} cho {requester} (dành cho {crafter})',
  'hudChrome.commissionBoard.scopeCrafter': 'Một thợ chế tác cụ thể',
  'hudChrome.commissionBoard.scopeLabel': 'Ai có thể chấp nhận',
  'hudChrome.commissionBoard.scopeOpen': 'Bất kỳ ai (bảng mở)',
  'hudChrome.commissionBoard.sectionBoard': 'Bảng Mở',
  'hudChrome.commissionBoard.sectionMine': 'Yêu Cầu Của Tôi',
  'hudChrome.commissionBoard.sectionToCraft': 'Đơn Ủy Thác Của Tôi',
  'hudChrome.commissionBoard.statusAccepted': 'Đã Chấp Nhận',
  'hudChrome.commissionBoard.statusCancelled': 'Đã Hủy',
  'hudChrome.commissionBoard.statusDelivered': 'Đã Giao',
  'hudChrome.commissionBoard.statusExpired': 'Đã Hết Hạn',
  'hudChrome.commissionBoard.statusOpen': 'Đang Mở',
  'hudChrome.commissionBoard.title': 'Đơn Ủy Thác',
  'hudChrome.commissionBoard.toCraftEmpty': 'Bạn hiện không chế tác đơn hàng của ai.',
  'hudChrome.controller.zoomIn': 'Phóng To',
  'hudChrome.controller.zoomOut': 'Thu Nhỏ',
  'hudChrome.crafting.announceCancel': 'Đã hủy chế tác',
  'hudChrome.crafting.announceComplete': 'Đã hoàn tất chế tác {name}',
  'hudChrome.crafting.announceStart': 'Đang chế tác {name}',
  'hudChrome.crafting.batchRemaining': 'Còn lại {remaining}/{total}',
  'hudChrome.crafting.batchRemainingAria': 'Còn lại {remaining}/{total} lượt chế tác',
  'hudChrome.crafting.busy': 'Bạn đang bận.',
  'hudChrome.crafting.crafting': 'Chế Tác',
  'hudChrome.crafting.create': 'Tạo',
  'hudChrome.crafting.createAll': 'Tạo Tất Cả',
  'hudChrome.crafting.createAllAria': 'Tạo số lượng tối đa của công thức này từ nguyên liệu đang có',
  'hudChrome.crafting.durationAria': 'Thời gian thi triển: {seconds} giây',
  'hudChrome.crafting.durationChip': '{seconds}g',
  'hudChrome.crafting.progressAria': 'Tiến trình chế tác',
  'hudChrome.crafting.qtyDecreaseAria': 'Giảm số lượng chế tác, hiện tại {count}',
  'hudChrome.crafting.qtyIncreaseAria': 'Tăng số lượng chế tác, hiện tại {count}',
  'hudChrome.crafting.qtyRowAria': 'Số lượng chế tác',
  'hudChrome.crafting.qtyValueAria': 'Số lượng chế tác, {count}',
  'hudChrome.crafting.skillUpSubtext': 'Kỹ năng tăng lên {level}!',
  'hudChrome.crafting.skillUpToast': 'Kỹ năng {skill} tăng lên {level}!',
  'hudChrome.enchanting.disenchantBusy': 'Bạn đang bận.',
  'hudChrome.enchanting.enchantBusy': 'Bạn đang bận.',
  'hudChrome.enchanting.salvageBusy': 'Bạn đang bận.',
  'hudChrome.gathering.earlyReelLine': 'Bạn giật cần quá sớm. Chưa có gì cắn mồi.',
  'hudChrome.itemUniqueEquipped': 'Độc Nhất Khi Trang Bị',
  'hudChrome.keybinds.bgFlag': 'Hành Động Cờ Chiến Trường',
  ...
  'hudChrome.options.gfxCharacterDetail': 'Chi Tiết Nhân Vật',
  'hudChrome.options.gfxCustomNote': 'Thay đổi một thiết lập sẽ chuyển cài đặt trước chất lượng sang Advanced: một hỗn hợp tùy chỉnh dựa trên nền chất lượng High, bắt đầu từ các mức hiển thị cho cài đặt trước hiện tại của bạn.',
  'hudChrome.options.gfxDynamicLights': 'Ánh Sáng Động',
  'hudChrome.options.gfxEffectsNote': 'Bóng Đổ Môi Trường, Độ Nở và Khử Răng Cưa đều nằm trên chuỗi hậu xử lý: khi Hiệu Ứng & Ánh Sáng ở mức Low, chuỗi này tắt và chúng không có tác dụng.',
  'hudChrome.options.gfxHalf': 'Nửa',
  'hudChrome.options.gfxParticleEffects': 'Hiệu Ứng Hạt',
  'hudChrome.options.gfxSectionCamera': 'Máy Quay',
  'hudChrome.options.gfxSectionDisplay': 'Hiển Thị',
  'hudChrome.options.gfxSectionLighting': 'Ánh Sáng & Hiệu Ứng',
  'hudChrome.options.gfxSectionQuality': 'Chất Lượng',
  'hudChrome.options.gfxSectionSystem': 'Hệ Thống',
  'hudChrome.options.gfxSectionTouch': 'Điều Khiển Cảm Ứng',
  'hudChrome.options.gfxSectionWorld': 'Chi Tiết Thế Giới',
  'hudChrome.options.gfxViewDistance': 'Tầm Nhìn Xa',
  'hudChrome.options.gfxWaterQuality': 'Chất Lượng Nước',
  'hudChrome.options.stopAutoAttackOnTargetSwitch': 'Dừng Tự Đánh Khi Đổi Mục Tiêu',
  'hudChrome.partyFrames.petHealth': 'Thú cưng {name}, {pct} máu',
  'hudChrome.partyFrames.showPets': 'Hiện Thú Cưng',
  'hudChrome.professions.toolEffectTooltip.bonus.artisansEye': 'Nâng bậc thu hoạch thêm 1 bậc công cụ trong khi còn nạp.',
  ...
  'hudChrome.townFocus.respecCostFree': 'Miễn Phí',
  'hudChrome.townFocus.respecCostLine': 'Tốn {coin} và {materials}',
  'hudChrome.townFocus.respecTierInstantOption': 'Tức thời (đầy đủ chi phí)',
  'hudChrome.townFocus.respecTierLabel': 'Tốc Độ Đặt Lại',
  'hudChrome.townFocus.respecTierPartialOption': 'Nhanh hơn (chi phí nhỏ)',
  'hudChrome.townFocus.respecTierTimeOption': 'Miễn phí (cứ từ từ)',
  'hudChrome.warfare.floatReasons.assist': 'Hỗ Trợ',
  'hudChrome.warfare.floatReasons.firstWin': 'Chiến Thắng Đầu Tiên',
  'hudChrome.warfare.floatReasons.kill': 'Hạ Gục',
  'hudChrome.warfare.honorFloatReason': '+{amount} Danh dự ({reason})',
  'hudChrome.warfare.reasons.battlegroundAssist': 'hỗ trợ đòn hạ gục',
  'hudChrome.warfare.reasons.battlegroundComplete': 'trận Cánh Đồng Trũng Gai đã đấu',
  'hudChrome.warfare.reasons.battlegroundFirstWin': 'chiến thắng Cánh Đồng Trũng Gai đầu tiên hôm nay',
  'hudChrome.warfare.reasons.battlegroundKill': 'hạ gục vinh dự',
  'hudChrome.warfare.reasons.battlegroundWin': 'chiến thắng Cánh Đồng Trũng Gai',
  'hudChrome.warfareShop.buyAria': 'Mua {item} với giá {honor}',
  'hudChrome.warfareShop.buyConfirmBody': 'Mua {item} với giá {honor}? Giao dịch mua bằng Danh dự không thể hoàn lại.',
  'hudChrome.warfareShop.buyOwnedAria': 'Mua {item} với giá {honor}, đã sở hữu',
  'hudChrome.warfareShop.gossipOption': 'Duyệt Bộ Chiến Tranh',
  'hudChrome.warfareShop.gossipOptionAria': 'Duyệt cửa hàng bộ Chiến Tranh do {name} cung cấp',
  'hudChrome.warfareShop.jewelry': 'Trang Sức',
  'hudChrome.warfareShop.owned': 'Sở Hữu',
  ...
  'hud.system.deathRecapKiller': 'Bạn đã chết. Bị hạ gục bởi {killer}.',
  'hud.system.deathRecapKillerAbility': 'Bạn đã chết. Bị hạ gục bởi {ability} của {killer}.',
  'hudChrome.bags.filterQuestCountAria': 'Nhiệm vụ, {count} vật phẩm',
  ...
  'hudChrome.bank.depositAllTooltip': 'Gửi toàn bộ nguyên liệu chế tác và vật phẩm linh tinh từ túi đồ của bạn vào ngân hàng chỉ trong một lần. Dụng cụ thu thập, trang bị đang mặc, vật phẩm nhiệm vụ, và vật phẩm tiêu hao sẽ không bao giờ bị động đến.',
  ...
  'hudChrome.bank.guildCapacityAria': 'Ô ngân hàng bang hội đã dùng: {used} trên {total}',
  'hudChrome.bank.guildContentsTab': 'Nội Dung',
  'hudChrome.bank.guildDepositGold': 'Gửi tiền',
  'hudChrome.bank.guildDepositGoldTitle': 'Gửi tiền vào ngân khố bang hội',
  'hudChrome.bank.guildDepositHint': 'Nhấp để gửi vào ngân hàng bang hội',
  'hudChrome.bank.guildDormantAria': '{item}, số lượng {count}, không thể rút ra',
  'hudChrome.bank.guildDormantHint': 'Vật phẩm này đang bị khóa trong ngân hàng bang hội và không thể rút ra.',
  'hudChrome.bank.guildDormantNote': 'Vật phẩm bị khóa không thể rút ra và ngăn cản việc giải tán bang hội.',
  'hudChrome.bank.guildEmpty': 'Ngân hàng bang hội trống rỗng.',
  'hudChrome.bank.guildGoldAvailable': 'Khả dụng: {amount}',
  'hudChrome.bank.guildGoldCannotMove': 'Số tiền đó hiện không thể chuyển được.',
  'hudChrome.bank.guildLogTab': 'Nhật Ký',
  'hudChrome.bank.guildOpenAccept': 'Mở',
  'hudChrome.bank.guildOpenBank': 'Mở ngân hàng bang hội',
  'hudChrome.bank.guildOpenConfirm': 'Mở ngân hàng bang hội với giá {price}? Khoản này được thanh toán từ tiền của chính bạn.',
  'hudChrome.bank.guildOpenNote': 'Thanh toán từ tiền của chính bạn, không phải từ ngân khố bang hội',
  'hudChrome.bank.guildPurseShort': 'Không đủ tiền',
  'hudChrome.bank.guildTab': 'Bang Hội',
  'hudChrome.bank.guildTreasury': 'Ngân khố bang hội',
  'hudChrome.bank.guildTreasuryShort': 'Ngân khố không đủ',
  'hudChrome.bank.guildUnknownItem': 'Vật phẩm không xác định',
  'hudChrome.bank.guildViewsAria': 'Các chế độ xem ngân hàng bang hội',
  'hudChrome.bank.guildWithdrawGold': 'Rút tiền',
  'hudChrome.bank.guildWithdrawGoldTitle': 'Rút tiền từ ngân khố bang hội',
  'hudChrome.bank.logAdminPurge': 'Một quản trị viên đã xóa {count} {item}',
  'hudChrome.bank.logAria': 'Nhật ký hoạt động ngân hàng bang hội',
  'hudChrome.bank.logBuySlots': '{actor} đã mua mở rộng ngân hàng với giá {amount}',
  'hudChrome.bank.logCharterFee': '{actor} đã trả phí thành lập bang hội là {amount}',
  'hudChrome.bank.logDepositItem': '{actor} đã gửi {count} {item}',
  'hudChrome.bank.logDepositMoney': '{actor} đã gửi {amount}',
  'hudChrome.bank.logEmpty': 'Chưa có gì được chuyển vào hoặc ra khỏi ngân hàng bang hội.',
  'hudChrome.bank.logFormerMember': 'Một cựu thành viên bang hội',
  ...
  'hudChrome.bank.tabsAria': 'Các thẻ ngân hàng',
  'hudChrome.crafting.dialogOption': 'Chế Tác',
  'hudChrome.crafting.dialogOptionAria': 'Mở cửa sổ chế tác cho {craft}',
  'hudChrome.deeds.recentJumpAria': 'Nhảy đến {name}',
  'hudChrome.landing.browserSupport.body': 'Bạn có thể gặp hiệu năng giảm sút trên trình duyệt này. Để có trải nghiệm tốt nhất, hãy tải ứng dụng máy tính cho Windows, macOS, hoặc Linux. Muốn chơi trên trình duyệt hơn? Chrome cho hiệu năng tốt nhất, và Firefox cùng Safari cũng được hỗ trợ.',
  'hudChrome.landing.browserSupport.continueInBrowser': 'Tiếp tục trên trình duyệt',
  'hudChrome.landing.browserSupport.dismissAria': 'Bỏ qua thông báo trình duyệt không được hỗ trợ',
  'hudChrome.landing.browserSupport.getDesktopApp': 'Tải ứng dụng máy tính',
  'hudChrome.landing.browserSupport.title': 'Lưu ý: trình duyệt không được hỗ trợ',
  'hudChrome.materialHint.cookingCatch': 'Nguyên liệu nấu ăn. Phải nấu chín trước khi ăn.',
  'hudChrome.mounts.desc_drakemaw_raptor': 'Một con Cuồng Long thuộc bầy đàn đã được thuần yên cương từ Miệng Núi Lửa Drakemaw, toàn thân gân cốt và tốc lực, vẫn còn phảng phất mùi tro tàn.',
  'hudChrome.mounts.name_drakemaw_raptor': 'Cuồng Long Drakemaw',
  'hudChrome.options.graphicsApplied': 'Đã áp dụng cài đặt đồ họa.',
  'hudChrome.options.graphicsApply': 'Áp Dụng Đồ Họa',
  'hudChrome.options.graphicsApplying': 'Đang áp dụng cài đặt đồ họa...',
  'hudChrome.options.graphicsDraftChanged': 'Các thay đổi đồ họa đã sẵn sàng để áp dụng.',
  'hudChrome.options.graphicsFailed': 'Không thể áp dụng cài đặt đồ họa. Cài đặt trước đó của bạn vẫn đang hoạt động.',
  'hudChrome.options.graphicsFatal': 'Khôi phục đồ họa thất bại. Hãy tải lại trò chơi để tiếp tục.',
  'hudChrome.options.graphicsReload': 'Tải Lại Trò Chơi',
  'hudChrome.options.graphicsRetry': 'Thử Lại Đồ Họa',
  'hudChrome.options.graphicsSaved': 'Đã lưu cài đặt đồ họa. Bộ kết xuất hiện tại đã khớp với cài đặt này.',
  'hudChrome.options.lockActionBars': 'Khóa Thanh Hành Động',
  'itemUi.kind.material': 'Nguyên Liệu',
  'itemUi.market.buyChanged': 'Rao bán đó đã thay đổi trước khi bạn xác nhận. Hãy kiểm tra giá và thử lại.',
  'itemUi.market.buyConfirmAccept': 'Mua',
  'itemUi.market.buyConfirmBody': 'Mua {item} với giá {price}?',
  'itemUi.market.buyConfirmBodyStack': 'Mua {item} x{count} với giá {price} ({each} mỗi cái)?',
  'itemUi.market.buyConfirmCancel': 'Hủy',
  'itemUi.market.buyConfirmTitle': 'Xác Nhận Mua',
  'itemUi.tooltip.questOrphaned': 'Không cần thiết cho bất kỳ nhiệm vụ đang thực hiện nào.',
  'itemUi.tooltip.questRelated': 'Nhiệm vụ: {quest}',
  'itemUi.tooltip.questRules': 'Không thể bán, gửi ngân hàng, hoặc trao đổi.',
  'desktop.update.checkingBody': 'Phiên bản mới sẽ được tải trong khi bạn chơi.',
  'desktop.update.checkingTitle': 'Đang kiểm tra cập nhật...',
  'desktop.update.dismiss': 'Bỏ Qua',
  'desktop.update.downloadingBody': 'Bạn có thể tiếp tục chơi. Bản cập nhật sẽ được cài đặt khi bạn thoát.',
  'desktop.update.uptodateTitle': 'Bạn đang dùng phiên bản mới nhất',
  'entities.items.firebottle.name': 'Bình Lửa',
  'entities.items.murloc_hut.name': 'Túp Lều Mudfin',
  'entities.items.reins_drakemaw_raptor.name': 'Dây Cương Cuồng Long Drakemaw',
  'entities.items.restless_skull.name': 'Hài Cốt Bất An',
  'entities.items.vanguard_bone.name': 'Xương Tiên Phong',
  'entities.mobs.brakka_wallbreaker.name': 'Brakka Kẻ Phá Thành',
  'entities.mobs.dragonkin_broodguard.name': 'Vệ Bầy Long Tộc',
  'entities.mobs.dragonkin_egg.name': 'Trứng Long Tộc',
  'entities.mobs.dragonkin_whelp.name': 'Rồng Con Long Tộc',
  'entities.mobs.drakemaw_broodlord.name': 'Lãnh Chúa Bầy Drakemaw',
  'entities.mobs.drowned_warlord.name': 'Chiến Tướng Chết Chìm',
  'entities.mobs.spider_egg.name': 'Trứng Nhện Mẹ',
  'entities.mobs.threnos_first_voice.name': 'Threnos Giọng Nói Đầu Tiên',
  'entities.mobs.widow_hatchling.name': 'Nhện Con Góa Phụ',
  ...
  'hudChrome.actionBar.bannerCapturing': 'Nhấn một phím để gán cho ô này...',
  'hudChrome.actionBar.boundToKey': 'Đã gán vào {key}.',
  'hudChrome.actionBar.reset': 'Đặt Lại',
  'hudChrome.actionBar.done': 'Xong',
  'hudChrome.actionBar.cancel': 'Hủy',
  'hudChrome.actionBar.resetConfirmTitle': 'Đặt lại phím thanh hành động?',
  'hudChrome.actionBar.resetConfirmBody': 'Thanh thứ nhất trở về phím mặc định. Thanh thứ hai và thứ ba sẽ không còn phím gán. Không thể hoàn tác.',
  'hudChrome.vcup.rolesSmallBracketNote': 'Ở hạng đấu 1v1 và 2v2, mọi đấu thủ đều dùng bộ kỹ năng Toàn Năng. Các kỳ công yêu cầu hạng đấu 3v3 trở lên không thể đạt được ở đây.',
  'hudChrome.vcup.practiceUnratedNote': 'Trận tập không tính hạng: bảng xếp hạng và tiến độ Sách Kỳ Công đều không được tính.',
  'hudChrome.vcup.briefing.unratedNote': 'Có máy trên sân, nên trận này không tính hạng: bảng xếp hạng không đổi, và kỳ công về bàn thắng, pha cản phá, và trận giữ sạch lưới không được tính.',
  'hudChrome.vcup.briefing.practiceUnratedNote': 'Đây là trận tập, nên không tính hạng: bảng xếp hạng không đổi, và tiến độ Sách Kỳ Công không được tính.',
  'hudChrome.bags.filterTool': 'Dụng cụ',
  'hudChrome.materialHint.fineGrade': 'Phẩm cấp hảo hạng. Thu được từ mạch đủ bậc bằng công cụ xếp trên nguyên liệu, và được tính như bản thường ở bất cứ đâu cần đến.',
  'hudChrome.gathering.toolTierUnmet.fishing': 'Bạn cần cần câu bậc {tier} để câu ở vùng nước này.',
  'hudChrome.gathering.wieldUnmet.mining': 'Bạn cần Khai mỏ {skill} để vung chiếc cuốc đã có trong túi.',
  'hudChrome.gathering.wieldUnmet.logging': 'Bạn cần Đốn gỗ {skill} để vung chiếc rìu đã có trong túi.',
  'hudChrome.gathering.wieldUnmet.herbalism': 'Bạn cần Thảo dược học {skill} để dùng chiếc liềm đã có trong túi.',
  'hudChrome.gathering.wieldUnmetCorpse': 'Bạn cần kỹ năng thu thập {skill} để dùng được công cụ tốt nhất của mình.',
  'hudChrome.gathering.toolTooltip.unlocks.fishing': 'Cần thiết để câu ở các vùng nước đến bậc {tier}.',
  'hudChrome.gathering.emptyHookNote': 'Không có gì dính câu',
  'hudChrome.gathering.stateCooldownTimed': 'Hồi sinh sau {time}',
  'hudChrome.gathering.respawnClock': '{minutes}:{seconds}',
  'hudChrome.gathering.fineGradePreview': 'Công cụ của bạn nâng sản vật này lên phẩm cấp hảo hạng.',
  'hudChrome.professions.toolEffectCharges': '{charges} trên {max} lượt dùng',
  'hudChrome.professions.toolEffectSpent': 'Đã cạn, cần nạp lại',
  'hudChrome.professions.toolEffectDepleted': 'Hiệu ứng công cụ đã cạn',
  'hudChrome.professions.toolEffectRechargePrice': 'Nạp lại: {count} x {material}',
  'hudChrome.professions.toolEffectModeAsk': 'Hỏi mỗi lần dùng',
  'hudChrome.professions.toolEffectModePrompt': 'Sẽ hỏi mỗi lần dùng',
  'hudChrome.professions.toolEffectConfirmTitle': 'Dùng {effect}?',
  'hudChrome.professions.toolEffectConfirmBody': 'Dùng một lượt cho lần thu hoạch này? Từ chối vẫn thu hoạch được, chỉ là không có phần thưởng thêm. Lượt còn lại: {charges}.',
  'hudChrome.professions.toolEffectConfirmAccept': 'Dùng Một Lượt',
  'hudChrome.professions.toolEffectConfirmDecline': 'Thu Hoạch Thường',
  'hudChrome.professions.toolEffectName.gatherersCache': 'Kho Của Thợ Thu Thập',
  'hudChrome.professions.toolEffectName.artisansEye': 'Mắt Nghệ Nhân',
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Bùa Hồi Nhanh',
  'hudChrome.professions.toolEffectSlotButton': 'Gắn {effect}',
  'hudChrome.professions.toolEffectRechargeButton': 'Nạp Lại',
  'hudChrome.professions.toolEffectSlotted': 'Đã gắn {effect} cho {profession}.',
  'hudChrome.professions.toolEffectSlotInvalid': 'Không thể gắn {effect} vào đó.',
  'hudChrome.professions.toolEffectNoTool': 'Bạn cần một công cụ {profession} thực thụ trước đã.',
  'hudChrome.professions.toolEffectNoCharm': 'Bạn cần một lá bùa {effect} được chế tác trong túi.',
  'hudChrome.professions.toolEffectNoGain': '{effect} đã được gắn và nạp đầy.',
  'hudChrome.professions.toolEffectRecharged': 'Đã nạp lại {effect}: tiêu tốn {material} x{count}.',
  'hudChrome.professions.toolEffectRechargeNoSlot': 'Chưa có hiệu ứng nào được gắn cho {profession}.',
  'hudChrome.professions.toolEffectRechargeFull': '{effect} đã được nạp đầy rồi.',
  'hudChrome.professions.toolEffectRechargeToolCapped': 'Hãy mang công cụ {profession} tốt hơn để nạp thêm cho {effect}.',
  'hudChrome.professions.toolEffectRechargeMaterials': 'Nạp lại {effect} cần {material} x{count}.',
  'hudChrome.crafting.reagentFineSub': '(tiêu tốn {count} hảo hạng)',
  'hudChrome.crafting.identity.allCrafts': 'Tất cả kỹ nghệ',
  'hudChrome.crafting.identity.skillListAria': 'Danh sách kỹ năng kỹ nghệ',
  ...
  'guide.profPages.toolCraftedOrMarks': 'Chế tạo ({craft}) hoặc {marks} Huy Hiệu Hang Sâu sau ba lượt hoàn thành Kinh Cầu Chết Chìm',
  'guide.profPages.toolCraftedOrMarksHeroic': 'Chế tạo ({craft}) hoặc {marks} Huy Hiệu Hang Sâu sau một lượt hoàn thành Kinh Cầu Chết Chìm Anh Hùng',
  'guide.profPages.priceNone': 'Không bán',
  'guide.profPages.colWield': 'Dùng được từ',
  'guide.profPages.wieldNone': 'Bất kỳ',
  ...
  'wallet.seekerAppHelp': 'Tiếp tục với ví Seed Vault. Hãy xem xét các yêu cầu kết nối và xác minh trong Seed Vault, rồi quay lại trò chơi.',
  'questUi.tracker.unknownQuest': 'Nhiệm vụ không rõ ({id})',
  'questUi.log.repeatableStatus': 'Lặp Lại',
  'questUi.log.cooldownStatus': 'Sắp Khả Dụng Lại',
  'questUi.dialog.repeatableQuestAria': 'Nhiệm vụ lặp lại: {name}',
  'itemUi.kind.fineMaterial': 'Nguyên Liệu Hảo Hạng',
  'itemUi.bags.unknownItem': 'Vật phẩm không rõ',
  'itemUi.bags.unknownItemAria': 'Vật phẩm không rõ {id}, số lượng {count}',
  'itemUi.bags.unknownItemAriaMasterwork': 'Vật phẩm không rõ {id}, số lượng {count}, kiệt tác',
  'itemUi.bags.unknownItemAriaEnchanted': 'Vật phẩm không rõ {id}, số lượng {count}, bản đã pháp khắc',
  'itemUi.bags.unknownItemAriaBound': 'Vật phẩm không rõ {id}, số lượng {count}, bản sao ràng buộc',
  'itemUi.bags.unknownItemAriaInstanced': 'Vật phẩm không rõ {id}, số lượng {count}, bản có dấu thợ',
  'itemUi.vendor.buyAriaWithRequirement': 'Mua {item} với giá {price}. {requirement}',
  'itemUi.vendor.qtyRowAria': 'Số lượng mua',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Mua {count} mỗi lần',
  'itemUi.vendor.qtyCustom': 'Tùy chỉnh',
  'itemUi.vendor.qtyCustomAria': 'Chọn số lượng mua tùy ý',
  'itemUi.vendor.buyCountAria': 'Mua {count} {item} với giá {price}',
  'itemUi.vendor.buyCountAriaWithRequirement': 'Mua {count} {item} với giá {price}. {requirement}',
  'itemUi.vendor.buyQuantityTitle': 'Mua bao nhiêu {item}? Tối đa {max}.',
  'itemUi.vendor.buyQuantityInput': 'Số lượng cần mua',
  'itemUi.vendor.buyQuantityConfirm': 'Mua',
  ...
  'entities.items.fine_silverleaf_herb.name': 'Thảo Dược Lá Bạc Thượng Hạng',
  'entities.items.fine_goldleaf_herb.name': 'Thảo Dược Lá Vàng Thượng Hạng',
  'entities.items.fine_sunpetal_herb.name': 'Thảo Dược Cánh Mặt Trời Thượng Hạng',
  'entities.items.stormreel_fishing_rod.name': 'Cần câu guồng bão',
  ...
  'entities.quests.q_prof_intro.completion': 'Thấy chưa? Quặng đã thu thập và tay đã có vết chai. Tiếp tục khai thác mỏ, chặt gỗ và hái thảo dược khi bạn đi trên đường, và khi trở lại thị trấn, chú ý đến bảng Trọng Tâm Thị Trấn gần chợ và bàn thủ công gần đó. Có một giao dịch công bằng chờ đợi trong tất cả, nếu bạn muốn.',
  ...
  'wallet.browser.completeBody': 'Bạn có thể quay lại ứng dụng máy tính Cryptic Realm.',
  ...
  'wallet.browser.safety':
    'Cryptic Realm không bao giờ yêu cầu cụm từ khôi phục hoặc khóa riêng tư của bạn.',
  ...
  'wallet.manualReturnStandaloneHelp':
    'Sau khi phê duyệt, hãy quay lại Cryptic Realm từ Màn hình chính của bạn. Nếu iOS mở một trình duyệt, hãy đóng nó và mở lại ứng dụng Màn hình chính thủ công.',
  ...
  'wallet.standaloneAppHelp':
    'Kết nối ví chưa có sẵn trong ứng dụng Màn hình chính. Hãy mở Cryptic Realm trong Safari hoặc Chrome để sử dụng Phantom hoặc Solflare.',
  ...
  'hudChrome.controller.duplicate': 'Cũng được gán cho {buttons}',
  ...
  'hudChrome.mobile.hideMenuButtons': 'Ẩn các nút trình đơn',
  'hudChrome.mobile.showMenuButtons': 'Hiện các nút trình đơn',
  'hudChrome.options.changed': '{count} mục đã đổi',
  'hudChrome.options.changedSummary': '{count} mục khác mặc định',
  'hudChrome.options.conflictDot': 'Xung đột phím gán',
  'hudChrome.options.done': 'Xong',
  'hudChrome.options.ia.catAccessibilityName': 'Khả Năng Tiếp Cận',
  'hudChrome.options.ia.catAccessibilitySub':
    'Chuyển động, độ tương phản và sự thoải mái về nội dung.',
  'hudChrome.options.ia.catAudioSub': 'Âm lượng và các tùy chọn bật tắt âm thanh.',
  'hudChrome.options.ia.catControllerSub': 'Cảm giác tay cầm và bố cục nút.',
  'hudChrome.options.ia.catControlsName': 'Điều Khiển',
  'hudChrome.options.ia.catControlsSub': 'Máy quay, di chuyển, chiến đấu và phản hồi.',
  'hudChrome.options.ia.catGraphicsSub': 'Chất lượng, tầm nhìn và hình ảnh thế giới.',
  'hudChrome.options.ia.catInterfaceSub': 'Tỷ lệ HUD, bảng, trò chuyện và khung đơn vị.',
  'hudChrome.options.ia.catKeybindsSub': 'Gán phím cho mọi hành động.',
  'hudChrome.options.ia.catOverviewName': 'Tổng Quan',
  'hudChrome.options.ia.catOverviewSub':
    'Các mục thiết yếu đã ghim, thao tác nhanh và những gì đã đổi.',
  'hudChrome.options.ia.catSystemName': 'Hệ Thống',
  'hudChrome.options.ia.catSystemSub': 'Hiệu năng, hỗ trợ và thông tin.',
  'hudChrome.options.ia.catTouchName': 'Cảm Ứng',
  'hudChrome.options.ia.catTouchSub': 'Cần điều khiển trên màn hình, tầm nhìn và nút.',
  'hudChrome.options.ia.railDisplay': 'Hiển Thị',
  'hudChrome.options.ia.railInput': 'Đầu Vào',
  'hudChrome.options.ia.railSystem': 'Hệ Thống',
  'hudChrome.options.keybindCleared': 'Đã xóa {action}',
  'hudChrome.options.keybindEvicted': 'Đã gán {key} cho {action}; gỡ khỏi {evicted}',
  'hudChrome.options.keybindModifierHint':
    'Mẹo: bạn có thể gán tổ hợp phím bổ trợ. Giữ Shift, Ctrl hoặc Alt trong khi nhấn một phím để ghi nhận tổ hợp (ví dụ Shift+1).',
  'hudChrome.options.keybindRebinding':
    'Đang gán lại {action}. Nhấn một phím, hoặc nhấn Escape để hủy.',
  'hudChrome.options.keybindTaken': 'Đã gỡ phím',
  'hudChrome.options.keybindUnbound': '{action} chưa có phím',
  'hudChrome.options.legend.back': 'Quay Lại',
  'hudChrome.options.legend.category': 'Danh Mục',
  'hudChrome.options.legend.clear': 'Xóa',
  'hudChrome.options.legend.navigate': 'Di Chuyển',
  'hudChrome.options.legend.page': 'Trang',
  'hudChrome.options.legend.reset': 'Đặt Lại',
  'hudChrome.options.legend.select': 'Chọn',
  'hudChrome.options.modeOffline': 'Ngoại Tuyến',
  'hudChrome.options.modeOnline': 'Trực Tuyến',
  'hudChrome.options.overviewConflictAlert': 'Một số phím gán bị xung đột hoặc chưa được gán.',
  'hudChrome.options.resetAllBody':
    'Thao tác này khôi phục mọi cài đặt về mặc định và không thể hoàn tác.',
  'hudChrome.options.resetAllTitle': 'Đặt lại mọi cài đặt?',
  'hudChrome.options.searchEmpty': 'Không có cài đặt nào khớp với tìm kiếm.',
  'hudChrome.options.searchGoTo': 'Đi tới {category}',
  'hudChrome.options.searchPlaceholder': 'Tìm kiếm cài đặt',
  'hudChrome.options.searchScopeAll': 'Mọi cài đặt',
  'hudChrome.options.searchScopeThis': 'Mục này',
  'hudChrome.options.sec.about': 'Thông Tin',
  'hudChrome.options.sec.actionBars': 'Thanh Hành Động',
  'hudChrome.options.sec.buttons': 'Nút',
  'hudChrome.options.sec.camera': 'Máy Quay',
  'hudChrome.options.sec.chat': 'Trò Chuyện',
  'hudChrome.options.sec.combat': 'Chiến Đấu',
  'hudChrome.options.sec.combatTooltips': 'Chiến Đấu và Chú Thích',
  'hudChrome.options.sec.content': 'Nội Dung',
  'hudChrome.options.sec.feedback': 'Phản Hồi',
  'hudChrome.options.sec.feel': 'Cảm Giác',
  ...
  'hudChrome.options.sec.performance': 'Hiệu Năng',
  'hudChrome.options.sec.quality': 'Chất Lượng',
  'hudChrome.options.sec.scaleText': 'Tỷ Lệ và Văn Bản',
  'hudChrome.options.sec.sticks': 'Cần Điều Khiển',
  'hudChrome.options.sec.support': 'Hỗ Trợ',
  'hudChrome.options.sec.toggles': 'Bật Tắt',
  'hudChrome.options.sec.unitFrames': 'Khung Đơn Vị',
  'hudChrome.options.sec.view': 'Tầm Nhìn',
  'hudChrome.options.sec.volume': 'Âm Lượng',
  ...
  'hudChrome.talents.choicesTab': 'Lựa Chọn',
  'hudChrome.talents.resetChoices': 'Đặt Lại Lựa Chọn',
  'hudChrome.talents.tierLevel': 'Cấp {n}',
  'hudChrome.talents.tierLevelLabel': 'Cấp',
  ...
  'entities.npcs.skirmish_builder.greeting': 'Rìu hay cuốc, thưa chỉ huy — chỉ cần ngài chỉ tay.',
  'entities.npcs.skirmish_builder.name': 'Thợ dựng trại',
  'entities.npcs.skirmish_builder.title': 'Giao tranh trại chiến',
  'entities.npcs.skirmish_footman.greeting': 'Hãy chỉ cho tôi lũ thổ phỉ.',
  'entities.npcs.skirmish_footman.name': 'Bộ binh trại',
  'entities.npcs.skirmish_footman.title': 'Giao tranh trại chiến',
  'entities.npcs.skirmish_post.greeting': 'Trại chiến vẫn đứng vững.',
  'entities.npcs.skirmish_post.name': 'Công trình trại chiến',
  'entities.npcs.skirmish_post.title': 'Giao tranh trại chiến',
  ...
  'editor.docTitle': 'Trình Chỉnh Sửa Bản Đồ - Cryptic Realm',
  ...
  'a11y.githubProject': 'Mở dự án GitHub của Cryptic Realm',
  ...
  'entities.abilities.battle_shout.description': 'Một tiếng hô làm tăng {buff}% sức mạnh tấn công của tất cả thành viên tổ đội trong 30 phút.',
  ...
  'entities.abilities.demoralizing_shout.description': 'Phát ra tiếng hô đáng sợ, giảm {buff}% sát thương do tất cả kẻ địch xung quanh gây ra trong 20 giây.',
  ...
  'playerCard.shareText':
    'Tôi đang rèn nên huyền thoại của mình trong Cryptic Realm: {className} cấp {level}{tierBit}. Hãy tham gia thế giới của tôi:',
  ...
  'seo.description':
    'Bắt đầu cuộc phiêu lưu hoành tráng trong Cryptic Realm, một micro-MMO phong cách cổ điển chơi trực tiếp trên trình duyệt của bạn. Tham gia một thế giới chung bền vững, lên cấp các lớp nhân vật và đánh bại kẻ thù!',
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'crypticrealm.com là trang MMO trên trình duyệt miễn phí chính thức cho thế giới Cryptic Realm. Chơi trực tuyến với một nhân vật bền vững, khám phá đơn lẻ ngoại tuyến, đọc wiki và theo dõi các liên kết cộng đồng đã được xác minh từ trang này.',
  ...
  'serverUnavailable.body':
    'Chúng tôi đang khởi động lại dịch vụ trò chơi và dự kiến Cryptic Realm sẽ trở lại trong giây lát. Trang này sẽ tự động tiếp tục kiểm tra.',
  ...
  'serverUnavailable.title': 'Cryptic Realm - Thế Giới Không Khả Dụng',
  ...
  'hudChrome.discord.swag.titleChampion': 'Danh Hiệu: Nhà Vô Địch Cryptic Realm',
  ...
  'desktop.crash.fatalBody': 'Cryptic Realm gặp lỗi không mong muốn và cần đóng lại.',
  ...
  'hudChrome.nativeUpdate.body':
    'Đã có phiên bản mới của Cryptic Realm. Cập nhật ngay để nhận các bản sửa lỗi và cải tiến mới nhất.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Đã có phiên bản {version} của Cryptic Realm. Cập nhật ngay để nhận các bản sửa lỗi và cải tiến mới nhất.',
  ...
  'hudChrome.unstuck.helpUnstuckSickness':
    'Cứu hộ: /unstuck bắt đầu đếm ngược khi đứng yên, sau đó đưa bạn đến nghĩa trang gần nhất và hồi sinh bạn nếu bạn đã ngã xuống. Hội Chứng Thoát Kẹt sẽ đè nặng lên bạn tối đa 5 phút.',
  'hudChrome.unstuck.menuButton': 'Thoát Kẹt',
  'hudChrome.unstuck.movedToGraveyard':
    'Bạn đã được đưa đến nghĩa trang gần nhất. Hội Chứng Thoát Kẹt đang đè nặng lên bạn.',
  ...
  'hudChrome.unstuck.revivedAtGraveyardUnstuck':
    'Bạn đã được đưa đến nghĩa trang gần nhất và hồi sinh. Hội Chứng Thoát Kẹt đang đè nặng lên bạn.',
  ...
  'auth.face': 'Khuôn mặt',
  'auth.faceNose': 'Mũi',
  'auth.faceEyes': 'Kích thước mắt',
  'auth.faceJaw': 'Hàm',
  'auth.faceBrow': 'Chân mày',
  'auth.faceCheeks': 'Má',
  'auth.faceChin': 'Cằm',
  'auth.mouth': 'Miệng',
  'auth.mouthNeutral': 'Bình thường',
  'auth.mouthLips': 'Môi dày',
  'auth.mouthSmile': 'Mỉm cười',
  'auth.mouthFrown': 'Cau mày',
  'auth.mouthWide': 'Rộng',
  'auth.mouthPout': 'Bĩu môi',
  'auth.mouthGrin': 'Cười toe',
  'auth.mouthOpen': 'Mở',
  'auth.mouthAwe': 'Kinh ngạc',
  'auth.faceEars': 'Tai',
  'auth.faceSmirk': 'Cười nhếch',
  'auth.eyeShape': 'Dáng mắt',
  'auth.eyeColor': 'Màu mắt',
  'auth.earShape': 'Dáng tai',
  'auth.browFlat': 'Thẳng',
  'auth.browArched': 'Cong',
  'auth.browThin': 'Mảnh',
  'auth.browBushy': 'Rậm',
  'auth.browWorried': 'Lo lắng',
  'auth.browSharp': 'Sắc',
  'auth.browRound': 'Tròn',
  'auth.eyeRound': 'Tròn',
  'auth.eyeAlmond': 'Hạnh nhân',
  'auth.eyeNarrow': 'Hẹp',
  'auth.eyeWide': 'Rộng',
  'auth.eyeSharp': 'Sắc',
  'auth.eyeDroopy': 'Xụ',
  'auth.eyeSleepy': 'Buồn ngủ',
  'auth.eyeWideset': 'Xa nhau',
  'auth.eyeCat': 'Mèo',
  'auth.eyeDoe': 'Nai',
  'auth.earRound': 'Tròn',
  'auth.earPointed': 'Nhọn',
  'auth.earSmall': 'Nhỏ',
  'auth.earWide': 'Rộng',
  'auth.customize': 'Tùy chỉnh',
  'auth.body': 'Cơ thể',
  'auth.genderMale': 'Nam',
  'auth.genderFemale': 'Nữ',
  'auth.hair': 'Tóc',
  'auth.brows': 'Lông mày',
  'auth.skinTone': 'Màu da',
  'auth.hairColor': 'Màu tóc',
  'auth.lightness': 'Sáng / Tối',
  'auth.colorWheelAria': 'Bánh xe màu {label}: kéo để chọn tông màu và độ bão hòa',
  'auth.lightnessAria': 'Độ sáng {label}',
  'auth.hairBald': 'Hói',
  'auth.browNone': 'Không có',
  'auth.browSoft': 'Mềm',
  'auth.browThick': 'Dày',
  'auth.browAngled': 'Xếch',
  'hudChrome.paperdoll.hideHelmAria': 'Ẩn mũ giáp',
  'hudChrome.paperdoll.showHelmAria': 'Hiện mũ giáp',
