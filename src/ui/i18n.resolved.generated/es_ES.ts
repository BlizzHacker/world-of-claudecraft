...
export const es_ES: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Ya hay disponible una nueva versión de Cryptic Realm. Actualiza ahora para obtener las últimas correcciones y mejoras.",
      "bodyWithVersion": "La versión {version} de Cryptic Realm ya está disponible. Actualiza ahora para obtener las últimas correcciones y mejoras.",
      "notNow": "Ahora no",
      "update": "Actualizar"
    },
    "cameraPrompt": {
    ...
    "account": {
      ...
      "connectionsSummary": "Gestiona proveedores de inicio de sesion vinculados a esta cuenta.",
      "sectionConnections": "Cuentas conectadas",
      "ssoLink": "Vincular Discord",
      "ssoLinkConflict": "Esa cuenta de Discord ya esta vinculada a otra cuenta.",
      "ssoLinked": "Discord vinculado.",
      "ssoNotLinked": "Discord no vinculado.",
      "ssoUnlink": "Desvincular Discord",
      "ssoUnlinkNeedsPassword": "Configura una contrasena antes de desvincular Discord."
    },
    "masterLoot": {
      "title": "Botin maestro",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Título: Campeón de Cryptic Realm",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "El mundo",
      "intro": "Cryptic Realm es una sola tierra continua que recorres a pie, tres zonas dispuestas de sur a norte. No hay viaje rápido, así que el trayecto forma parte de la aventura.",
  ...
  "news": {
    ...
    "alphaBetaBody": "Los testers alpha ganan mas platino porque los personajes se reinician cada dos semanas. Beta se promueve mensualmente tras revision.",
    "alphaBetaTitle": "Ritmo de alpha, beta y reino publico",
    "officialLog": "Registro oficial",
    "openLink": "Abrir",
    "prBody": "Mejoras genericas de motor, auth, paneles y wiki se comparten con ClaudeCraft mientras lo propio de Cryptic Realm queda aqui.",
    "prTitle": "Pista de mejoras upstream",
    "proofBody": "La pagina publica de prueba muestra mint, tesoreria y enlaces de Solscan.",
    "proofTitle": "Prueba de $CR",
    "tokenBody": "$CR es el token SPL de Solana de Cryptic Realm. El platino conecta cosmeticos, casas, monturas, mercado y Exchange.",
    "tokenTitle": "$CR y utilidad de platino"
  },
  "download": {
    ...
    "linuxHint": "AppImage: hazlo ejecutable y ejecutalo. No requiere instalacion.",
  ...
  "auth": {
    ...
    "email": "Correo de recuperacion",
    "emailPlaceholder": "you@example.com",
    "emailError": "Introduce una direccion de correo valida.",
    ...
    "recovery": {
      "title": "Anadir correo de recuperacion",
      "body": "Configura una direccion de correo para poder recuperar tu cuenta. Solo la usamos para confirmar que esta cuenta te pertenece si alguna vez necesitas restablecer tu contrasena.",
      "save": "Guardar correo",
      "logOut": "Cerrar sesion",
      "invalid": "Introduce una direccion de correo valida.",
      "failed": "No se pudo guardar tu correo. Intentalo de nuevo."
    },
    "hardcoreChar": "Personaje extremo",
    "hardcoreHint": "Muerte permanente. Si este personaje muere, queda retirado para siempre y no podra jugarse. No hay resurreccion.",
    "ladderChar": "Personaje de liga",
    "ladderHint": "Compite en la liga de temporada. Al final de la temporada se convierte en personaje estandar y conserva el progreso.",
    "ssoButton": "Continua con Google, Facebook o Plex",
    "ssoMoveweight": "Iniciar con MoveWeight",
    "ssoProviders": "Continua con Google, Facebook, Plex o Discord"
  },
  "wallet": {
    "label": "Cartera $CR",
    ...
    "balanceTitle": "Saldo de $CR de la cartera de Solana verificada",
    "balanceAria": "Saldo de la cartera de Solana verificada: {balance}",
    "balancePreviewTitle": "Vista previa del saldo de $CR de la cartera conectada",
    ...
    "standaloneAppHelp": "Las conexiones de cartera aún no están disponibles en la aplicación de la pantalla de inicio. Abre Cryptic Realm en Safari o Chrome para usar Phantom o Solflare.",
    ...
    "manualReturnStandaloneHelp": "Tras la aprobación, vuelve a Cryptic Realm desde tu pantalla de inicio. Si iOS abre un navegador, ciérralo y vuelve a abrir la aplicación de la pantalla de inicio manualmente.",
    ...
    "browser": {
      ...
      "safety": "Cryptic Realm nunca solicita tu frase de recuperación ni tu clave privada.",
      ...
      "completeBody": "Puedes volver a la aplicación de escritorio de Cryptic Realm.",
    ...
    "holderTierTitle": "Titular de $CR de nivel {tier}",
    "holderTiers": {
      "ember": {
        "name": "Ascua",
      ...
      "vaultwarden": {
        ...
        "flavor": "Ahora custodias una bóveda real: el 0,01 % del suministro de $CR."
      },
      "whale": {
        "name": "Ballena",
  ...
  "playerCard": {
    ...
    "arenaStat": "Arena",
    "shareTierBit": ", titular de $CR de rango {tier}",
    "shareText": "Estoy forjando mi leyenda en Cryptic Realm: nivel {level} {className}{tierBit}. Únete a mi mundo:",
  ...
  "seo": {
    ...
    "officialLabel": "Sitio web oficial de Cryptic Realm",
    "officialBody": "crypticrealm.com es el MMO de navegador gratuito oficial del mundo Cryptic Realm. Juega en línea con un personaje persistente, explora en solitario sin conexión, lee la wiki y sigue los enlaces comunitarios verificados desde este sitio."
  },
  "a11y": {
    ...
    "githubProject": "Abrir el proyecto Cryptic Realm en GitHub",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recargar",
      "quit": "Salir",
      "fatalBody": "Cryptic Realm tuvo un error inesperado y debe cerrarse."
    }
  },
  "gpuNotice": {
  ...
  "serverUnavailable": {
    "title": "Cryptic Realm: Mundo no disponible",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "race_marshal_pip": {
        "name": "Comisaria de carrera Pip",
        "title": "Guardiana de la Rueda Espinosa",
        "greeting": "¿Seis karts, tres vueltas y unos frenos que no merecen el nombre, {className}? Firma el registro y toma un puesto en la parrilla."
      },
      "pit_master_grott": {
        "name": "Maestro del foso Grott",
        "title": "Guardián del Foso del Jabalí",
        "greeting": "Puños, pies y lo que el valle te haya dado, {className}. En mi foso no muere nadie: de eso se encargan las estacas. ¿Te apuntas al cartel?"
      },
      "realtor_maribel": {
