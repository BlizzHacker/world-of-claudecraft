...
export const zh_TW: EnTranslations = {
  ...
  "auth": {
    ...
    "ladderChar": "天梯角色",
    "ladderHint": "參與賽季天梯。賽季結束時轉為標準角色（保留全部進度）。",
    "hardcoreChar": "硬核角色",
    "hardcoreHint": "永久死亡。該角色一旦死亡將被永久退役，無法再次遊玩。沒有復活。",
    "class": "職業",
    "name": "名稱",
    "chromaOption": "配色 {n}",
  ...
  "hud": {
    ...
    "options": {
      ...
      "padAttackTarget": "攻擊最近 · 鎖定目標",
      "padInteract": "互動 / 與 NPC 對話",
      "padSkills12": "技能 1 和 2",
      "padSkills47": "技能 5–8",
      "padSkillChords": "按住 + A/B/X/Y 使用技能 9–16",
      "padCursorToggle": "切換滑鼠游標",
      "padCursorNote": "當選單、任務對話框或聊天開啟時，螢幕游標會自動啟用——用搖桿移動並按 A 點擊（接受任務、傳送聊天、使用選單）。",
      "mouseCamera": "滑鼠鏡頭",
