...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "sectionConnections": "Bagli hesaplar",
      "connectionsSummary": "Bu hesaba bagli oturum acma saglayicilarini yonet.",
      "ssoNotLinked": "Discord bagli degil.",
      "ssoLinked": "Discord baglandi.",
      "ssoLink": "Discord bagla",
      "ssoUnlink": "Discord bagini kes",
      "ssoLinkConflict": "Bu Discord hesabi zaten baska bir hesaba bagli.",
      "ssoUnlinkNeedsPassword": "Discord bagini kesmeden once parola ayarla.",
  ...
  "news": {
    ...
    "openLink": "Ac",
    "officialLog": "Resmi kayit",
    "alphaBetaTitle": "Alpha, beta ve acik realm temposu",
    "alphaBetaBody": "Alpha testcileri daha cok platinum kazanir cunku karakterler iki haftada bir sifirlanir. Beta incelemeden sonra aylik olarak acik realme cikar.",
    "tokenTitle": "$CR ve platinum kullanimi",
    "tokenBody": "$CR, Cryptic Realm icin Solana SPL tokenidir. Platinum kozmetik, ev, binek, pazar ve Exchange ile bag kurar.",
    "prTitle": "Upstream izi",
    "prBody": "Genel motor, auth, panel ve wiki iyilestirmeleri ClaudeCraft ile paylasilir; Cryptic Realm ozel isleri burada kalir.",
    "proofTitle": "$CR kaniti",
    "proofBody": "Acik kanit sayfasi mint, treasury ve Solscan baglantilarini gosterir."
  },
  "contributions": {
    "title": "Contributions",
  ...
  "auth": {
    ...
    "appearance": "Görünüm",
    "ssoMoveweight": "MoveWeight ile giris yap",
    "ssoProviders": "Google, Facebook, Plex veya Discord ile devam et",
    "ssoButton": "Google, Facebook veya Plex ile devam et",
    "ladderChar": "Ladder karakteri",
    "ladderHint": "Sezonluk ladder da yarisir. Sezon sonunda standart karaktere donusur ve tum ilerlemeyi korur.",
    "hardcoreChar": "Hardcore karakter",
    "hardcoreHint": "Kalici olum. Bu karakter olurse kalici olarak emekli olur ve artik oynanamaz. Dirilis yoktur.",
    "class": "Sınıf",
    "name": "Ad",
    "chromaOption": "Renk {n}",
    ...
    "email": "Kurtarma e-postasi",
    "emailPlaceholder": "you@example.com",
    "emailError": "Gecerli bir e-posta adresi gir.",
    "recovery": {
