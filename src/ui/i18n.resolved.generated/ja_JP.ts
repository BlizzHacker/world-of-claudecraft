...
export const ja_JP: EnTranslations = {
  ...
  "auth": {
    ...
    "ssoProviders": "Google、Facebook、Plex、Discordで続行",
    "ladderChar": "ラダーキャラクター",
    "ladderHint": "シーズンラダーで競います。シーズン終了時に通常キャラクターへ変換されます（進行状況はすべて保持）。",
    "hardcoreChar": "ハードコアキャラクター",
    "hardcoreHint": "パーマデス。このキャラクターが死亡すると永久に引退し、二度とプレイできません。蘇生はありません。",
    "class": "クラス",
    "name": "名前",
    "chromaOption": "カラー {n}",
  ...
  "hud": {
    ...
    "options": {
      ...
      "padMenu": "ゲームメニューを開く",
      "padMove": "Move",
      "padLookCursor": "視点 / カーソル移動",
      "padJumpClick": "ジャンプ · カーソルモードでクリック",
      "padAttackTarget": "最寄りを攻撃 · ターゲット",
      "padInteract": "インタラクト / NPCと会話",
      "padSkills12": "スキル1と2",
      "padSkills47": "スキル5〜8",
      "padSkillChords": "長押し + A/B/X/Y でスキル9〜16",
      "padCursorToggle": "マウスカーソル切替",
      "padCursorNote": "メニュー、クエストダイアログ、チャットが開くと画面カーソルが自動的に有効になります。スティックで動かし、Aを押してクリックします（クエスト受諾、チャット送信、メニュー操作）。",
      "mouseCamera": "マウスカメラ",
