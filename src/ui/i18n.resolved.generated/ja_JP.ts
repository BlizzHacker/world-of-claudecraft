...
export const ja_JP: EnTranslations = {
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "ホーム画面アプリでは、まだウォレットに接続できません。Phantom または Solflare を使用するには、Safari か Chrome で Cryptic Realm を開いてください。",
    ...
    "manualReturnStandaloneHelp": "承認後、ホーム画面から Cryptic Realm に戻ってください。iOS でブラウザが開いた場合は閉じ、ホーム画面のアプリをもう一度開いてください。",
    ...
    "browser": {
      ...
      "safety": "Cryptic Realmがリカバリーフレーズや秘密鍵を求めることはありません。",
      ...
      "completeBody": "Cryptic Realmデスクトップアプリに戻れます。",
  ...
  "playerCard": {
    ...
    "shareText": "Cryptic Realmで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:",
  ...
  "seo": {
    ...
    "description": "ブラウザで直接遊べるクラシック風マイクロMMO、Cryptic Realm で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。",
    "genre": "MMORPG",
    "playMode": "マルチプレイヤー",
  ...
  "loading": {
    ...
    "tips": {
      ...
      "infernal": {
        "delves": "ヒント：デルヴは深く潜るほど過酷になります。降りる前に補給を整えましょう。",
        "rifts": "ヒント：ランク付きの裂け目ポータルが王国各地に開きます。高ランクほど強敵で、報酬も豪華です。",
        "crypts": "ヒント：地下墓地の奥は蝋燭の光も乏しいもの。暗がりでは足元にご注意を。"
      },
      "classic": {
        "dungeons": "ヒント：英雄はダンジョンで生まれます。パーティを組んでボスを倒しましょう。",
        "wanderers": "ヒント：広い空は放浪者に報います。マップの辺境にはレア敵や採集ポイントが潜んでいます。",
        "deeds": "ヒント：偉業は功績の書に刻まれます。称号と名声が冒険者を待っています。"
      },
      "arcane": {
        "portals": "ヒント：水晶の国はポータルの力に満ちています。ワールドの裂け目は寄り道の価値ありです。",
        "relics": "ヒント：遺物と素材は根気強い者に微笑みます。採集専門技能を鍛えて稼ぎましょう。",
        "study": "ヒント：虚空の神秘は学究の徒のもの。タレントを振り直す前によく読み込みましょう。"
      },
      "dominion": {
        "squads": "ヒント：フロンティアでは分隊が有利です。ダンジョンファインダーで仲間をすぐ集められます。",
        "formation": "ヒント：陣形を保ちましょう。前衛のタンクと後衛のヒーラーが長期戦を制します。",
        "momentum": "ヒント：係争地はすぐに支配者が変わります。分隊に勢いがあるうちに攻めましょう。"
      },
      "arcadevoid": {
        "movement": "ヒント：虚空の闘技場では機動力が命。動き続け、立ち止まって戦わないこと。",
        "focus": "ヒント：ネオンの銃撃戦は一瞬で決まります。分隊で一体ずつ集中攻撃しましょう。",
        "upkeep": "ヒント：虚空の技術は手入れが肝心。戦闘の合間に装備の更新を確認しましょう。"
      }
    },
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "race_marshal_pip": {
        "name": "レースマーシャル・ピップ",
        "title": "ソーンホイールの番人",
        "greeting": "カートは6台、3周勝負、ブレーキは名ばかりだ、{className}よ。台帳にサインしてグリッドに並ぶかい？"
      },
      "pit_master_grott": {
        "name": "ピットマスター・グロット",
        "title": "ボアピットの番人",
        "greeting": "拳も足も、谷が授けたものは何でもありだ、{className}よ。俺のピットじゃ誰も死なない——杭がそれを保証する。出場札に名を書くかい？"
      },
      "realtor_maribel": {
        "name": "不動産屋マリベル",
        "title": "イーストブルック・ホームズ",
