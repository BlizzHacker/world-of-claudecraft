...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "manageWallet": "管理钱包",
      "sectionConnections": "关联账户",
      "connectionsSummary": "关联 Google、Facebook 或 Plex，即可用它们登录。",
      "ssoNotLinked": "未关联。",
      "ssoLinked": "已关联 — 你可以使用 Google、Facebook 或 Plex 登录。",
      "ssoLink": "关联 Google / Facebook / Plex",
      "ssoUnlink": "取消关联",
      "ssoLinkConflict": "该账户已关联到另一个 Cryptic Realm 登录。",
      "ssoUnlinkNeedsPassword": "请先设置密码 — SSO 目前是你唯一的登录方式。",
      "deactivate": "注销账户",
  ...
  "mode": {
    ...
    "caLabel": "$CR 合约地址",
    "caCopyAria": "复制合约地址",
    "caNote": "CR 是我们的社区代币。游玩游戏并不需要它。加入 Discord 一起讨论 CR 的用途与飞轮效应。"
  },
  "auth": {
    "enterRealm": "进入服务器",
    "username": "用户名",
    ...
    "newCharacter": "新建角色",
    "appearance": "外观",
    "ssoMoveweight": "使用 MoveWeight 登录",
    "ssoProviders": "使用 Google、Facebook、Plex 或 Discord 继续",
    "ssoButton": "使用 Google、Facebook 或 Plex 继续",
    "ladderChar": "天梯角色",
    "ladderHint": "参与赛季天梯排名。赛季结束后将转换为普通角色（保留所有进度）。",
    "hardcoreChar": "硬核角色",
    "hardcoreHint": "永久死亡。此角色一旦死亡将永久退役，无法再游玩。没有复活机会。",
    "class": "职业",
    "name": "名称",
    "chromaOption": "配色 {n}",
  ...
  "realm": {
    ...
    "enter": "进入领域",
    "exchangeNote": "交易所是唯一可以在各领域之间转移物品的领域。"
  },
  "character": {
    "loading": "正在加载...",
  ...
  "hud": {
    ...
    "options": {
      ...
      "padMenu": "打开游戏菜单",
      "padMove": "Move",
      "padLookCursor": "视角 / 移动光标",
      "padJumpClick": "跳跃 · 光标模式下点击",
      "padAttackTarget": "攻击最近目标 · 选定目标",
      "padInteract": "互动 / 与NPC交谈",
      "padSkills12": "技能 1 和 2",
      "padSkills47": "技能 5–8",
      "padSkillChords": "按住 + A/B/X/Y 使用技能9–16",
      "padCursorToggle": "切换鼠标光标",
      "padCursorNote": "打开菜单、任务对话或聊天时，屏幕光标会自动启用——用摇杆移动，按 A 键点击（接受任务、发送聊天、使用菜单）。",
      "mouseCamera": "鼠标镜头",
