...
export const zh_CN: EnTranslations = {
  ...
  "auth": {
    ...
    "hardcoreChar": "硬核角色",
    "hardcoreHint": "永久死亡。该角色一旦死亡将被永久退役，无法再次游玩。没有复活。",
    "class": "职业",
    "name": "名称",
    "chromaOption": "配色 {n}",
  ...
  "realm": {
    ...
    "enter": "进入领域",
    "exchangeNote": "交易所是唯一可以在领域之间转移物品的领域。"
  },
  "character": {
    "loading": "正在加载...",
  ...
  "hud": {
    ...
    "options": {
      ...
      "padAttackTarget": "攻击最近 · 锁定目标",
      "padInteract": "互动 / 与 NPC 对话",
      "padSkills12": "技能 1 和 2",
      "padSkills47": "技能 5–8",
      "padSkillChords": "按住 + A/B/X/Y 使用技能 9–16",
      "padCursorToggle": "切换鼠标光标",
      "padCursorNote": "当菜单、任务对话框或聊天打开时，屏幕光标会自动启用——用摇杆移动并按 A 点击（接受任务、发送聊天、使用菜单）。",
      "mouseCamera": "鼠标镜头",
