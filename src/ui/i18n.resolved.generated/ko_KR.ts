...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "manageWallet": "지갑 관리",
      "sectionConnections": "Yeongyeol doen gyejeong",
      "connectionsSummary": "I gyejeongui yeongyeol login gonggeupjareul gwanrihamnida.",
      "ssoNotLinked": "Discord yeongyeol an doem.",
      "ssoLinked": "Discord yeongyeol doem.",
      "ssoLink": "Discord yeongyeol",
      "ssoUnlink": "Discord yeongyeol haeje",
      "ssoLinkConflict": "Geu Discord gyejeong eun imi dareun gyejeong e yeongyeol doeeotseumnida.",
      "ssoUnlinkNeedsPassword": "Discord yeongyeol haeje jeon password reul seoljeonghaseyo.",
      "deactivate": "계정 비활성화",
  ...
  "news": {
    ...
    "openLink": "Yeolgi",
    "officialLog": "Gongsik logu",
    "alphaBetaTitle": "Alpha, beta, gonggae realm jujugi",
    "alphaBetaBody": "Alpha tester neun du ju mada character ga reset doeeo platinum eul deo batseumnida. Beta neun geomto hu mae dal gonggae realm euro ollagamnida.",
    "tokenTitle": "$CR gwa platinum yongdo",
    "tokenBody": "$CR neun Cryptic Realm ui Solana SPL token imnida. Platinum eun cosmetic, house, mount, market, Exchange reul yeongyeolhamnida.",
    "prTitle": "Upstream hyeomnyeok",
    "prBody": "Engine, auth, dashboard, wiki ui gongtong gaeseon eun ClaudeCraft wa gongyu hago Cryptic Realm jeonyong gineung eun yeogi namgyeodumnida.",
    "proofTitle": "$CR jeungmyeong",
    "proofBody": "Gonggae jeungmyeong page e mint, treasury, Solscan link ga itsseumnida."
  },
  "contributions": {
    "title": "Contributions",
  ...
  "auth": {
    ...
    "newCharacter": "새 캐릭터",
    "appearance": "외형",
    "ssoMoveweight": "MoveWeight ro login",
    "ssoProviders": "Google, Facebook, Plex ttoneun Discord ro gyesok",
    "ssoButton": "Google, Facebook ttoneun Plex ro gyesok",
    "ladderChar": "Laedeo kaerikteo",
    "ladderHint": "Season ladder e chamyeohamnida. Season jongnyo si pyojun kaerikteo ro byeonhwan doego jinhaengdo yuji doemnida.",
    "hardcoreChar": "Hardcore kaerikteo",
    "hardcoreHint": "Yeongu si mang. I kaerikteoga jugeumyeon yeonggu retire doego dasi play hal su eopseumnida. Buhwal eopseumnida.",
    "class": "직업",
    "name": "이름",
    "chromaOption": "색상 {n}",
