...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "칭호: Cryptic Realm의 챔피언",
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "홈 화면 앱에서는 아직 지갑 연결을 사용할 수 없습니다. Phantom 또는 Solflare를 사용하려면 Safari나 Chrome에서 Cryptic Realm를 여세요.",
    ...
    "manualReturnStandaloneHelp": "승인 후 홈 화면에서 Cryptic Realm로 돌아오세요. iOS에서 브라우저가 열리면 닫고 홈 화면 앱을 다시 여세요.",
  ...
  "seo": {
    ...
    "officialBody": "crypticrealm.com은 Cryptic Realm 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요."
  },
  "a11y": {
    "goHome": "홈으로 이동",
    "toggleMenu": "메뉴 전환",
  ...
  "loading": {
    ...
    "tips": {
      ...
      "infernal": {
        "delves": "팁: 탐굴은 깊이 들어갈수록 험난해집니다. 내려가기 전에 보급품을 챙기세요.",
        "rifts": "팁: 등급이 매겨진 균열 차원문이 왕국 곳곳에 열립니다. 등급이 높을수록 싸움은 어렵고 보상은 풍성합니다.",
        "crypts": "팁: 지하 묘지 깊은 곳은 촛불조차 드뭅니다. 어둠 속에서는 발밑을 조심하세요."
      },
      "classic": {
        "dungeons": "팁: 영웅은 던전에서 만들어집니다. 파티를 모아 함께 우두머리를 처치하세요.",
        "wanderers": "팁: 탁 트인 하늘은 방랑자에게 보답합니다. 지도의 외딴 구석에 희귀 몬스터와 채집지가 숨어 있습니다.",
        "deeds": "팁: 위업은 업적의 서에 기록됩니다. 칭호와 명성이 모험가를 기다립니다."
      },
      "arcane": {
        "portals": "팁: 수정의 세계에는 차원문의 기운이 흐릅니다. 세계 균열은 언제나 들러 볼 가치가 있습니다.",
        "relics": "팁: 유물과 재료는 끈기 있는 자의 몫입니다. 채집 전문 기술을 익혀 이득을 챙기세요.",
        "study": "팁: 공허의 신비는 탐구자의 것입니다. 특성을 초기화하기 전에 꼼꼼히 읽어 보세요."
      },
      "dominion": {
        "squads": "팁: 개척지에서는 분대가 유리합니다. 던전 찾기로 빠르게 인원을 채울 수 있습니다.",
        "formation": "팁: 대형을 유지하세요. 앞의 탱커와 뒤의 힐러가 긴 싸움을 승리로 이끕니다.",
        "momentum": "팁: 분쟁 지역은 주인이 금세 바뀝니다. 분대의 기세가 오를 때 밀어붙이세요."
      },
      "arcadevoid": {
        "movement": "팁: 공허 투기장에서는 기동이 생명입니다. 계속 움직이고 제자리에서 싸우지 마세요.",
        "focus": "팁: 네온 총격전은 순식간에 끝납니다. 분대가 한 목표에 화력을 모아 하나씩 제압하세요.",
        "upkeep": "팁: 공허 기술은 정비가 중요합니다. 전투 사이에 장비 업그레이드를 확인하세요."
      }
    },
