...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "manageWallet": "지갑 관리",
      "sectionConnections": "연결된 계정",
      "connectionsSummary": "Google, Facebook 또는 Plex를 연결하면 해당 계정으로 로그인할 수 있습니다.",
      "ssoNotLinked": "연결되지 않음.",
      "ssoLinked": "연결됨 — Google, Facebook 또는 Plex로 로그인할 수 있습니다.",
      "ssoLink": "Google / Facebook / Plex 연결",
      "ssoUnlink": "연결 해제",
      "ssoLinkConflict": "해당 계정은 이미 다른 Cryptic Realm 로그인에 연결되어 있습니다.",
      "ssoUnlinkNeedsPassword": "먼저 비밀번호를 설정하세요 — 현재 SSO가 유일한 로그인 방법입니다.",
      "deactivate": "계정 비활성화",
  ...
  "auth": {
    ...
    "newCharacter": "새 캐릭터",
    "appearance": "외형",
    "ssoMoveweight": "MoveWeight로 로그인",
    "ssoProviders": "Google, Facebook, Plex 또는 Discord로 계속하기",
    "ssoButton": "Google, Facebook 또는 Plex로 계속하기",
    "ladderChar": "래더 캐릭터",
    "ladderHint": "시즌 래더에서 경쟁합니다. 시즌 종료 시 일반 캐릭터로 전환됩니다 (모든 진행 상황 유지).",
    "hardcoreChar": "하드코어 캐릭터",
    "hardcoreHint": "영구 사망. 이 캐릭터가 죽으면 영구히 은퇴하며 더 이상 플레이할 수 없습니다. 부활은 없습니다.",
    "class": "직업",
    "name": "이름",
    "chromaOption": "색상 {n}",
  ...
  "realm": {
    ...
    "enter": "렐름 입장",
    "exchangeNote": "Exchange는 아이템이 렐름 간에 이동할 수 있는 유일한 렐름입니다."
  },
  "character": {
    "loading": "불러오는 중...",
  ...
  "hud": {
    ...
    "options": {
      ...
      "arcforge": "ArcForge",
      "controller": "컨트롤러",
      "controllerDisconnected": "연결 안 됨",
      "padLeftStick": "왼쪽 스틱",
      "padRightStick": "오른쪽 스틱",
      "padA": "A",
      "padXY": "X / Y",
      "padB": "B",
      "padLbRb": "LB / RB",
      "padDpad": "D-Pad",
      "padLtRt": "LT / RT (누르고 있기)",
      "padBack": "Back / View",
      "padStart": "시작 / 메뉴",
      "padMenu": "게임 메뉴 열기",
      "padMove": "Move",
      "padLookCursor": "시점 / 커서 이동",
      "padJumpClick": "점프 · 커서 모드에서 클릭",
      "padAttackTarget": "가장 가까운 대상 공격 · 타겟",
      "padInteract": "상호작용 / NPC와 대화",
      "padSkills12": "스킬 1 & 2",
      "padSkills47": "스킬 5-8",
      "padSkillChords": "누르고 + A/B/X/Y로 스킬 9-16",
      "padCursorToggle": "마우스 커서 전환",
      "padCursorNote": "메뉴, 퀘스트 대화상자 또는 채팅이 열리면 화면 커서가 자동으로 활성화됩니다 — 스틱으로 이동하고 A 버튼으로 클릭하세요 (퀘스트 수락, 채팅 전송, 메뉴 사용).",
      "mouseCamera": "마우스 카메라",
