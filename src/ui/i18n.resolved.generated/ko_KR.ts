...
export const ko_KR: EnTranslations = {
  ...
  "auth": {
    ...
    "ssoProviders": "Google, Facebook, Plex 또는 Discord로 계속",
    "ladderChar": "래더 캐릭터",
    "ladderHint": "시즌 래더에서 경쟁합니다. 시즌이 끝나면 일반 캐릭터로 전환됩니다(모든 진행 상황 유지).",
    "hardcoreChar": "하드코어 캐릭터",
    "hardcoreHint": "영구 죽음. 이 캐릭터가 죽으면 영구적으로 은퇴되어 더 이상 플레이할 수 없습니다. 부활은 없습니다.",
    "class": "직업",
    "name": "이름",
    "chromaOption": "색상 {n}",
  ...
  "hud": {
    ...
    "options": {
      ...
      "padAttackTarget": "가장 가까운 적 공격 · 타겟",
      "padInteract": "상호작용 / NPC와 대화",
      "padSkills12": "스킬 1 & 2",
      "padSkills47": "스킬 5–8",
      "padSkillChords": "누르기 + A/B/X/Y로 스킬 9–16",
      "padCursorToggle": "마우스 커서 전환",
      "padCursorNote": "메뉴, 퀘스트 대화, 채팅이 열리면 화면 커서가 자동으로 활성화됩니다. 스틱으로 움직이고 A를 눌러 클릭하세요(퀘스트 수락, 채팅 전송, 메뉴 사용).",
      "mouseCamera": "마우스 카메라",
