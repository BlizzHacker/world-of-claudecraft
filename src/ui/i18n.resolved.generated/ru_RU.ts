...
export const ru_RU: EnTranslations = {
  ...
  "auth": {
    ...
    "hardcoreHint": "Перманентная смерть. Если этот персонаж погибнет, он навсегда выбывает и в него больше нельзя играть. Воскрешения нет.",
    "class": "Класс",
    "name": "Имя",
  ...
  "hud": {
    ...
    "options": {
      ...
      "arcforge": "ArcForge",
      "controller": "Геймпад",
      "controllerDisconnected": "Не подключён",
      ...
      "padMove": "Move",
      "padLookCursor": "Обзор / движение курсора",
      "padJumpClick": "Прыжок · клик в режиме курсора",
      "padAttackTarget": "Атаковать ближайшего · цель",
      "padInteract": "Взаимодействие / говорить с NPC",
      "padSkills12": "Умения 1 и 2",
      "padSkills47": "Умения 5–8",
      "padSkillChords": "Удерживать + A/B/X/Y для умений 9–16",
      "padCursorToggle": "Переключить курсор мыши",
      "padCursorNote": "Когда открыто меню, диалог задания или чат, экранный курсор включается автоматически — двигайте его стиком и нажмите A для клика (принять задание, отправить сообщение, использовать меню).",
