...
export const ru_RU: EnTranslations = {
  ...
  "wallet": {
    ...
    "standaloneAppHelp": "Подключение кошелька пока недоступно в приложении с главного экрана. Для Phantom или Solflare откройте Cryptic Realm в Safari или Chrome.",
    ...
    "manualReturnStandaloneHelp": "После подтверждения вернитесь в Cryptic Realm с экрана «Домой». Если iOS откроет браузер, закройте его и снова откройте приложение с экрана «Домой».",
    ...
    "browser": {
      ...
      "safety": "Cryptic Realm никогда не запрашивает фразу восстановления или закрытый ключ.",
      ...
      "completeBody": "Можно вернуться в приложение Cryptic Realm.",
  ...
  "loading": {
    ...
    "tips": {
      ...
      "infernal": {
        "delves": "Совет: чем глубже вылазка, тем суровее враги. Запаситесь всем необходимым перед спуском.",
        "rifts": "Совет: по королевству открываются ранговые порталы разломов. Чем выше ранг, тем тяжелее бой и богаче добыча.",
        "crypts": "Совет: в глубине склепов свечей почти нет. В темноте смотрите под ноги."
      },
      "classic": {
        "dungeons": "Совет: герои рождаются в подземельях. Соберите группу и одолейте босса вместе.",
        "wanderers": "Совет: открытые просторы щедры к странникам. В дальних углах карты прячутся редкие враги и месторождения.",
        "deeds": "Совет: подвиги заполняют вашу Книгу деяний. Титулы и Известность ждут смелых."
      },
      "arcane": {
        "portals": "Совет: хрустальные миры гудят от энергии порталов. Мировой разлом всегда стоит крюка.",
        "relics": "Совет: реликвии и реагенты любят терпеливых. Освойте собирательскую профессию и заработайте.",
        "study": "Совет: тайны пустоты покоряются прилежным. Внимательно изучите таланты перед сбросом."
      },
      "dominion": {
        "squads": "Совет: на фронтире побеждают отряды. Поиск подземелий быстро наберёт вам группу.",
        "formation": "Совет: держите строй. Танк впереди и лекарь позади выигрывают затяжные бои.",
        "momentum": "Совет: спорные земли быстро меняют хозяев. Атакуйте, пока отряд на подъёме."
      },
      "arcadevoid": {
        "movement": "Совет: в аренах пустоты решает манёвр. Постоянно перемещайтесь и не стойте на месте.",
        "focus": "Совет: неоновые перестрелки скоротечны. Сосредоточьте огонь отряда на одной цели.",
        "upkeep": "Совет: пустотные технологии требуют ухода. Между боями проверяйте снаряжение на обновки."
      }
    },
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "race_marshal_pip": {
        "name": "Распорядительница гонок Пип",
        "title": "Хранительница Тернового Колеса",
        "greeting": "Шесть карт, три круга и тормоза, не стоящие своего имени, {className}. Распишешься в книге и займёшь место на решётке?"
      },
      "pit_master_grott": {
        "name": "Хозяин ямы Гротт",
        "title": "Хранитель Кабаньей Ямы",
        "greeting": "Кулаки, ноги и всё, чем одарила тебя долина, {className}. В моей яме никто не умирает — за этим следят колья. Впишешь себя в список боёв?"
      },
      "realtor_maribel": {
      ...
      "skirmish_post": {
        "name": "Постройка военного лагеря",
        "title": "Стычка военного лагеря",
        "greeting": "Военный лагерь держится."
      },
      "skirmish_builder": {
        "name": "Лагерный строитель",
        "title": "Стычка военного лагеря",
        "greeting": "Топор или кирка, командир — только укажи."
      },
      "skirmish_footman": {
        "name": "Лагерный пехотинец",
        "title": "Стычка военного лагеря",
        "greeting": "Укажи мне на банду."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
