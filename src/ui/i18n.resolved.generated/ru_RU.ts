...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "sectionConnections": "Связанные аккаунты",
      "connectionsSummary": "Свяжите Google, Facebook или Plex, чтобы входить через них.",
      "ssoNotLinked": "Не связано.",
      "ssoLinked": "Связано — вы можете входить через Google, Facebook или Plex.",
      "ssoLink": "Связать Google / Facebook / Plex",
      "ssoUnlink": "Отвязать",
      "ssoLinkConflict": "Этот аккаунт уже связан с другим входом в Cryptic Realm.",
      "ssoUnlinkNeedsPassword": "Сначала задайте пароль — сейчас SSO ваш единственный способ входа.",
  ...
  "auth": {
    ...
    "ssoMoveweight": "Войти через MoveWeight",
    "ssoProviders": "Продолжить через Google, Facebook, Plex или Discord",
    "ssoButton": "Продолжить через Google, Facebook или Plex",
    "ladderChar": "Персонаж лиги",
    "ladderHint": "Участвует в сезонной лиге. По окончании сезона превращается в обычного персонажа (весь прогресс сохраняется).",
    "hardcoreChar": "Хардкорный персонаж",
    "hardcoreHint": "Перманентная смерть. Если этот персонаж погибнет, он навсегда выбывает из игры и его больше нельзя будет использовать. Воскрешения нет.",
    "class": "Класс",
    "name": "Имя",
  ...
  "realm": {
    ...
    "enter": "Войти в мир",
    "exchangeNote": "Exchange — единственный мир, где предметы можно переносить между мирами."
  },
  "character": {
    "loading": "Загрузка...",
  ...
  "hud": {
    ...
    "options": {
      ...
      "arcforge": "ArcForge",
      "controller": "Геймпад",
      "controllerDisconnected": "Не подключен",
      "padLeftStick": "Левый стик",
      "padRightStick": "Правый стик",
      "padA": "A",
      "padXY": "X / Y",
      "padB": "B",
      "padLbRb": "LB / RB",
      "padDpad": "D-Pad",
      "padLtRt": "LT / RT (удерживать)",
      "padBack": "Back / View",
      "padStart": "Start / Меню",
      "padMenu": "Открыть игровое меню",
      "padMove": "Move",
      "padLookCursor": "Обзор / перемещение курсора",
      "padJumpClick": "Прыжок · клик в режиме курсора",
      "padAttackTarget": "Атаковать ближайшую цель · выбор цели",
      "padInteract": "Взаимодействие / разговор с NPC",
      "padSkills12": "Навыки 1 и 2",
      "padSkills47": "Навыки 5–8",
      "padSkillChords": "Удерживать + A/B/X/Y для навыков 9–16",
      "padCursorToggle": "Переключить курсор мыши",
      "padCursorNote": "При открытии меню, диалога квеста или чата курсор на экране активируется автоматически — перемещайте его стиком и нажимайте A для клика (принятие квестов, отправка сообщений, работа с меню).",
