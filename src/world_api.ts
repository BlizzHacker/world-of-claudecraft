...
export const COMMAND_NAMES = [
  ...
  'delve_rite_choose',
  'telemetry',
  // Downstream (Cryptic Realm) ArcForge world-builder tokens (admin/mod only;
  // server re-validates the role). Appended after upstream's universe per the
  // APPEND-ONLY rule; carry music/voice-on-props via setPropMeta.meta.
  'placeProp',
  'moveProp',
  'removeProp',
  'setPropMeta',
...
export const COMMAND_FACETS = {
  ...
  waypoint_travel: 'IWorldInteraction',
  ...
  // IWorldInteraction: downstream ArcForge world-builder commands (admin/mod only).
  placeProp: 'IWorldInteraction',
  moveProp: 'IWorldInteraction',
  removeProp: 'IWorldInteraction',
  setPropMeta: 'IWorldInteraction',
