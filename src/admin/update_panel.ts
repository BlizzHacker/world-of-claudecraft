...
const TOKEN_KEY = 'cryptic-realm_admin_token';
...
function render(host: HTMLElement, s: StatusPayload | null): void {
  ...
  host.innerHTML = `
    <div class="cr-admin-panel">
      ...
      <p class="cr-dim">Triggers <code>scripts/admin/update.sh</code> via the server — broadcasts a maintenance warning to in-game sessions, flips <code>.maintenance</code>, pulls / rebuilds, restarts all realm processes.</p>
