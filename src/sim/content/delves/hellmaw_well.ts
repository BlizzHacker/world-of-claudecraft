...
const OUTER_SANCTUM_SPAWNS = {
  ...
  spawns: [
    ...
    { mobId: 'hellmaw_cinder_acolyte', x: -16, z: 48 },
    ...
    { mobId: 'hellmaw_charred_husk', x: 20, z: 84 },
...
const BLOOD_GALLERY_SPAWNS = {
  ...
  weight: 1,
  spawns: [
    { mobId: 'hellmaw_cinder_acolyte', x: -18, z: 18 },
    { mobId: 'hellmaw_cinder_acolyte', x: 18, z: 20 },
    { mobId: 'hellmaw_charred_husk', x: -8, z: 24 },
    { mobId: 'hellmaw_charred_husk', x: 8, z: 26 },
    { mobId: 'hellmaw_charred_husk', x: 0, z: 34 },
...
const CHASM_SPAWNS = {
  ...
  weight: 1,
  spawns: [
    { mobId: 'hellmaw_ember_behemoth', x: -14, z: 26 },
    { mobId: 'hellmaw_ember_behemoth', x: 14, z: 30 },
    { mobId: 'hellmaw_charred_husk', x: 0, z: 20 },
    { mobId: 'hellmaw_charred_husk', x: -18, z: 22 },
    ...
    { mobId: 'hellmaw_cinder_acolyte', x: -16, z: 78 },
...
const PYRE_SPAWNS = {
  ...
  spawns: [
    ...
    { mobId: 'hellmaw_charred_husk', x: 0, z: 56 },
    { mobId: 'hellmaw_ember_behemoth', x: -12, z: 74 },
