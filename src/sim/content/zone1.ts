...
export const ZONE1_ZONE: ZoneDef = {
  ...
  pois: [
    ...
    { x: 124, z: 32, label: 'Thornwheel Circuit', id: 'thornwheel_circuit' },
    { x: 30, z: 110, label: 'The Boarpit', id: 'the_boarpit' },
    { x: -36, z: -36, label: 'Eastbrook Homes', id: 'eastbrook_homes' },
