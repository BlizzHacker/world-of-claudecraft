...
export const ARCANE_REALM: RealmContent = {
  ...
  season: {
    ...
    body: 'Limited weapon skins drawn from the crystal vaults of the Arcane Nexus. Account-wide, purely cosmetic, and shown to everyone around you.',
  },
  accentHex: '#a855f7',
      ...
      skills: [
        {
          ...
          dmg: 280,
          range: 14,
          desc: 'Beam of void energy that disintegrates matter',
          color: '#a855f7',
        },
        {
          ...
          dmg: 320,
          range: 6,
          desc: 'Open a rift that pulls in and damages enemies',
          color: '#6c5ce7',
        },
        {
          name: 'Blink',
          ...
          dmg: 0,
          range: 12,
          desc: 'Teleport short distance, leaving void echo',
          color: '#00bcd4',
        },
        {
          name: 'Nullify',
          ...
          dmg: 0,
          range: 10,
          desc: 'Silence target, preventing spells for 5s',
          color: '#7f8c8d',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 8,
          desc: 'Encase ally in crystal, absorbing 400 damage',
          color: '#3ad6c8',
        },
        {
          name: 'Prismatic Beam',
          ...
          dmg: 180,
          range: 12,
          desc: 'Fire a beam that splits into 3 random elements',
          color: '#e879f9',
        },
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Party gains +25% all stats for 12s',
          color: '#ffd700',
        },
        {
          name: 'Crystal Prison',
          ...
          dmg: 120,
          range: 10,
          desc: 'Encase enemy in crystal for 4s',
          color: '#3498db',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 12,
          desc: 'Open portal to healing dimension, restore 50% HP to area',
          color: '#2ecc71',
        },
        {
          name: 'Banishment',
          ...
          dmg: 0,
          range: 10,
          desc: 'Banish enemy to pocket dimension for 6s',
          color: '#e879f9',
        },
        {
          name: 'Redirect',
          ...
          dmg: 0,
          range: 8,
          desc: 'Redirect next attack on ally to yourself (with 50% reduction)',
          color: '#f39c12',
        },
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Party immune to knockback and teleport for 10s',
          color: '#7f8c8d',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 100,
          range: 7,
          desc: 'Create gravity well pulling all enemies toward center',
          color: '#2c3e50',
        },
        {
          name: 'Star Shield',
          ...
          dmg: 0,
          range: 0,
          desc: 'Absorb 60% of all incoming damage for 8s',
          color: '#fbbf24',
        },
        {
          name: 'Nova Burst',
          ...
          dmg: 280,
          range: 6,
          desc: 'Release stored stellar energy in devastating burst',
          color: '#f39c12',
        },
        {
          name: 'Time Dilation',
          ...
          dmg: 0,
          range: 8,
          desc: 'Slow all enemies to 30% speed for 6s',
          color: '#a855f7',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 300,
          range: 3,
          desc: 'Cut through dimensional fabric, ignoring armor',
          color: '#06b6d4',
        },
        {
          name: 'Phase Step',
          ...
          dmg: 0,
          range: 14,
          desc: 'Phase through reality to appear at target location',
          color: '#a855f7',
        },
        {
          name: 'Void Blades',
          ...
          dmg: 0,
          range: 0,
          desc: 'Weapons gain +80% damage and void piercing for 10s',
          color: '#6c5ce7',
        },
        {
          name: 'Reality Tear',
          ...
          dmg: 350,
          range: 5,
          desc: 'Tear a hole in reality, massive damage to all nearby',
          color: '#e74c3c',
        },
      ],
