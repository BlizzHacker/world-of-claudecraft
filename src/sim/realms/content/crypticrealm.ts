...
export const CRYPTICREALM_REALM: RealmContent = {
  ...
  season: {
    ...
    body: 'Limited weapon skins recovered from the ciphered vaults beneath Cryptic Realm. Account-wide, purely cosmetic, and shown to everyone around you.',
  },
  accentHex: '#b48cff',
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Raise a riddle-bound revenant that fights for 30s',
          color: '#b48cff',
        },
        {
          ...
          dmg: 120,
          range: 12,
          desc: 'Speak a forbidden name; target takes 120 and is silenced 4s',
          color: '#8e44ad',
        },
        {
          name: 'Soul Ledger',
          ...
          dmg: 0,
          range: 0,
          desc: 'Spend a bound soul to restore 30% HP',
          color: '#2ecc71',
        },
        {
          name: 'The Last Riddle',
          icon: '\u{1F5DD}',
          mp: 55,
          type: 'AoE',
          dmg: 480,
          range: 8,
          desc: 'Pose an unanswerable question; all nearby enemies take 480 over 6s',
          color: '#6c5ce7',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Inscribe a glyph absorbing the next 400 damage',
          color: '#ffd166',
        },
        {
          name: 'Runic Slam',
          ...
          dmg: 240,
          range: 3,
          desc: 'Smash with a rune-etched maul, stunning 2s',
          color: '#e67e22',
        },
        {
          name: 'Sealing Chains',
          ...
          dmg: 60,
          range: 8,
          desc: 'Bind a target in arcane chains for 4s',
          color: '#95a5a6',
        },
        {
          name: 'Vault Bulwark',
          ...
          dmg: 0,
          range: 0,
          desc: '+60% defense to nearby allies for 10s',
          color: '#f1c40f',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 260,
          range: 3,
          desc: 'A cut that carves a rune; bleeds for 90 over 5s',
          color: '#7bdff2',
        },
        {
          name: 'Blink Cipher',
          ...
          dmg: 0,
          range: 12,
          desc: 'Teleport behind target, next hit crits',
          color: '#3498db',
        },
        {
          name: 'Silent Verse',
          ...
          dmg: 0,
          range: 6,
          desc: 'Mark target; your hits on them ignore 40% armor',
          color: '#9b59b6',
        },
        {
          name: 'Final Sentence',
          ...
          dmg: 520,
          range: 3,
          desc: 'Execute: 520 damage, doubled below 25% HP',
          color: '#e74c3c',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 12,
          desc: 'Restore 280 HP to an ally',
          color: '#2ecc71',
        },
        {
          name: 'Prophecy Ward',
          ...
          dmg: 0,
          range: 10,
          desc: 'Foresee danger: ally takes -35% damage for 8s',
          color: '#1abc9c',
        },
        {
          name: 'Unwritten Fate',
          ...
          dmg: 0,
          range: 0,
          desc: 'Group heal 180 + cleanse one debuff',
          color: '#16a085',
        },
        {
          name: 'Foretold Doom',
          ...
          dmg: 220,
          range: 12,
          desc: 'Speak an enemy’s end; 220 damage, -25% healing taken',
          color: '#e74c3c',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 270,
          range: 16,
          desc: 'Hurl condensed nothing for 270 damage',
          color: '#6c5ce7',
        },
        {
          name: 'Riddle Rift',
          ...
          dmg: 180,
          range: 10,
          desc: 'Tear a rift that pulls enemies in and deals 180',
          color: '#8e44ad',
        },
        {
          name: 'Unmake',
          ...
          dmg: 420,
          range: 14,
          desc: 'Erase a target from the page: 420 ignoring armor',
          color: '#5b3fb0',
        },
        {
          name: 'Eclipse',
          ...
          dmg: 0,
          range: 0,
          desc: 'Channel the void: +50% spell damage for 8s',
          color: '#2c2c54',
        },
      ],
