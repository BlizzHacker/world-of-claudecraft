...
export const INFERNAL_REALM: RealmContent = {
  ...
  season: {
    ...
    body: 'Limited weapon skins lifted from the ember-lit reliquaries beneath the Infernal Realm. Account-wide, purely cosmetic, and shown to everyone around you.',
  },
  accentHex: '#d4442a',
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 8,
          desc: 'Summon 3 skeletal warriors that fight for 20s',
          color: '#8e7cc3',
        },
        {
          name: 'Bone Spear',
          ...
          dmg: 185,
          range: 14,
          desc: 'Pierce through enemies with a spear of calcified death',
          color: '#c0c0c0',
        },
        {
          ...
          dmg: 260,
          range: 5,
          desc: 'Detonate a corpse dealing massive AoE damage',
          color: '#d4442a',
        },
        {
          name: 'Life Tap',
          ...
          dmg: 0,
          range: 0,
          desc: 'Convert 15% HP to MP instantly',
          color: '#c0392b',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 310,
          range: 7,
          desc: 'Rain molten fire across a wide area for 4s',
          color: '#e67e22',
        },
        {
          name: 'Immolate',
          ...
          dmg: 120,
          range: 10,
          desc: 'Set target ablaze, dealing damage over 8s',
          color: '#ff4500',
        },
        {
          name: 'Flame Nova',
          ...
          dmg: 380,
          range: 6,
          desc: 'Explode in a ring of fire around you',
          color: '#ffd700',
        },
        {
          name: 'Ember Dash',
          ...
          dmg: 80,
          range: 0,
          desc: 'Dash forward leaving a trail of fire',
          color: '#ff6347',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 12,
          desc: 'Teleport behind target, next attack crits',
          color: '#6c5ce7',
        },
        {
          name: 'Venom Strike',
          ...
          dmg: 150,
          range: 2,
          desc: 'Poison target for 120 damage over 10s',
          color: '#2ecc71',
        },
        {
          name: 'Blade Storm',
          ...
          dmg: 220,
          range: 4,
          desc: 'Spin blades in all directions at blinding speed',
          color: '#c0c0c0',
        },
        {
          name: 'Death Mark',
          ...
          dmg: 0,
          range: 8,
          desc: 'Mark target: all damage taken +50% for 8s',
          color: '#d4442a',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Gain 60% damage reduction for 10s, taunt all',
          color: '#7f8c8d',
        },
        {
          name: 'Shield Slam',
          ...
          dmg: 200,
          range: 3,
          desc: 'Slam shield into target, stun for 2s',
          color: '#95a5a6',
        },
        {
          name: 'Ground Quake',
          ...
          dmg: 180,
          range: 6,
          desc: 'Stomp ground, stunning all nearby for 3s',
          color: '#d35400',
        },
        {
          name: 'Rallying Cry',
          ...
          dmg: 0,
          range: 0,
          desc: 'Party gains 25% max HP shield for 12s',
          color: '#f1c40f',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 10,
          desc: "Restore 40% of target's max HP",
          color: '#27ae60',
        },
        {
          ...
          dmg: 60,
          range: 8,
          desc: 'Root target for 4s, dealing damage over time',
          color: '#8b4513',
        },
        {
          name: 'Spore Cloud',
          ...
          dmg: 140,
          range: 6,
          desc: 'Release toxic spores, healing allies and poisoning enemies',
          color: '#9b59b6',
        },
        {
          name: 'Ancient Bark',
          ...
          dmg: 0,
          range: 8,
          desc: 'Encase ally in bark armor, +40% def for 10s',
          color: '#2ecc71',
        },
      ],
