...
export const CLASSIC_REALM: RealmContent = {
  ...
  season: {
    ...
    body: "Limited weapon skins from the Classic Realm's adventurer armories. Account-wide, purely cosmetic, and shown to everyone around you.",
  },
  accentHex: '#4a9eff',
      ...
      skills: [
        {
          ...
          dmg: 220,
          range: 3,
          desc: 'Strike with divine wrath, healing self for 20% of damage',
          color: '#ffd700',
        },
        {
          name: 'Divine Shield',
          ...
          dmg: 0,
          range: 0,
          desc: 'Become immune to all damage for 6s',
          color: '#ffffff',
        },
        {
          name: 'Consecrate',
          ...
          dmg: 160,
          range: 5,
          desc: 'Sanctify the ground, damaging undead and demons',
          color: '#f58cba',
        },
        {
          name: 'Judgment',
          ...
          dmg: 180,
          range: 10,
          desc: 'Mark enemy as unworthy, -30% defense for 10s',
          color: '#e74c3c',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 280,
          range: 18,
          desc: 'Arrow pierces through all enemies in a line',
          color: '#abd473',
        },
        {
          name: 'Multishot',
        ...
        },
        {
          ...
          dmg: 350,
          range: 20,
          desc: 'Fire an arrow from the void, ignoring armor',
          color: '#6c5ce7',
        },
        {
          name: 'Evasive Roll',
          ...
          dmg: 0,
          range: 0,
          desc: 'Roll to dodge, gaining 50% evasion for 3s',
          color: '#3498db',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 260,
          range: 14,
          desc: 'Hurl a bolt of condensed shadow',
          color: '#2c3e50',
        },
        {
          name: 'Summon Imp',
          ...
          dmg: 0,
          range: 0,
          desc: 'Summon a fireball-throwing imp for 30s',
          color: '#e74c3c',
        },
        {
          name: 'Drain Life',
          ...
          dmg: 100,
          range: 8,
          desc: 'Siphon life force, healing self for damage dealt',
          color: '#c0392b',
        },
        {
          name: 'Curse of Doom',
          ...
          dmg: 600,
          range: 12,
          desc: 'Curse target, dealing massive damage after 15s',
          color: '#8e44ad',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Summon a dire wolf companion (120 DPS)',
          color: '#7f8c8d',
        },
        {
          name: 'Eagle Strike',
          ...
          dmg: 200,
          range: 15,
          desc: 'Eagle swoops down on target',
          color: '#f39c12',
        },
        {
          name: 'Bear Hug',
          ...
          dmg: 80,
          range: 3,
          desc: 'Bear stuns target for 3s with a crushing grip',
          color: '#8b4513',
        },
        {
          name: 'Pack Howl',
          ...
          dmg: 0,
          range: 0,
          desc: 'All pets gain 40% damage and 30% speed for 12s',
          color: '#c79c6e',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Party gains 50% attack speed for 8s',
          color: '#00bcd4',
        },
        {
          name: 'Rewind',
          ...
          dmg: 0,
          range: 0,
          desc: 'Rewind HP to where it was 5 seconds ago',
          color: '#2ecc71',
        },
        {
          ...
          dmg: 0,
          range: 10,
          desc: "Freeze target in time for 5s (can't act or be hit)",
          color: '#3498db',
        },
        {
          name: 'Decay',
          ...
          dmg: 200,
          range: 10,
          desc: "Fast-forward target's aging, 200 damage over 8s",
          color: '#9b59b6',
        },
      ],
