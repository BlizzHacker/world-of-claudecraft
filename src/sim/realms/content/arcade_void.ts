...
export const ARCADE_VOID_REALM: RealmContent = {
  ...
  season: {
    ...
    body: 'Limited weapon finishes stripped from the void shipyards. Account-wide, purely cosmetic, and shown to everyone around you.',
  },
  accentHex: '#57f0ff',
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Brace behind powered plating and cut incoming damage.',
          color: '#57f0ff',
        },
        {
          name: 'Pulse Burst',
          ...
          dmg: 180,
          range: 7,
          desc: 'Fire a close-range cone of kinetic rounds.',
          color: '#ffcf4a',
        },
        {
          name: 'Crash Advance',
          ...
          dmg: 140,
          range: 8,
          desc: 'Push through the line and stagger enemies.',
          color: '#ff6b6b',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Fade out while sprinting between cover.',
          color: '#b967ff',
        },
        {
          name: 'Mark Shot',
          ...
          dmg: 320,
          range: 18,
          desc: 'Tag a weak point and strike for heavy damage.',
          color: '#57f0ff',
        },
        {
          name: 'Orbital Knife',
          ...
          dmg: 420,
          range: 3,
          desc: 'Blink behind the target for a finisher.',
          color: '#ff6b6b',
        },
      ],
      ...
      skills: [
        {
          ...
          dmg: 0,
          range: 0,
          desc: 'Deploy a sentry that fires at nearby enemies.',
          color: '#ffcf4a',
        },
        {
          name: 'Repair Cloud',
          ...
          dmg: 0,
          range: 8,
          desc: 'Nanite mist repairs allies and constructs.',
          color: '#4dff9b',
        },
        {
          name: 'Mine Web',
          ...
          dmg: 260,
          range: 6,
          desc: 'Lay proximity mines across the path.',
          color: '#ff6b6b',
        },
      ],
