...
namespace CrypticRealm.Shell
{
    ...
    /// game itself needs no console-specific code.
    ///
    /// Button order is the Standard Gamepad mapping, because that is what the
    /// game's own bindings and remap UI index by.
    /// </summary>
