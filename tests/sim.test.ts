...
describe('leveling', () => {
  ...
  it('caps at max level', () => {
    // Vanilla cap behaviour: force a cap-20 realm (the default crypticrealm realm
    // caps at 99 now, so a huge XP grant would level past 20 there; that path is
    // covered in level_cap.test.ts).
    setRealmHostEnv({
