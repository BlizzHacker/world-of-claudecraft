...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/coop/regroup',
    handler: 'handleApi arm: /api/coop/regroup',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'routeHttpRequest arm: /api/contributions',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'POST',
    path: '/api/bug-report',
    handler: 'handleApi arm: /api/bug-report',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/oauth/authentik/status',
    handler: 'handleAuthentikRoute arm: /api/oauth/authentik/status',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/oauth/authentik/link',
    handler: 'handleAuthentikRoute arm: /api/oauth/authentik/link (GET)',
  ...
  },
  {
    ...
    handler: 'handleAuthentikRoute arm: /api/oauth/authentik',
    contentType: REDIRECT,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/oauth/authentik/callback',
    handler: 'handleAuthentikRoute arm: /api/oauth/authentik/callback',
    contentType: HTML,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/forged-props',
    handler: 'routeHttpRequest arm: /api/forged-props (handleForgedCatalog)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'routeHttpRequest arm: /api/asset-library (handleAssetLibraryCatalog)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  ...
  },
  {
    ...
    handler: 'handleAdminApi arm: /admin/api/grant-gm',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
