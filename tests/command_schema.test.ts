...
const EXPECTED_SEND_COUNT = 143; // includes the generic minigame lifecycle sends.
const EXPECTED_DISPATCH_COUNT = 152; // includes the generic minigame lifecycle cases.
