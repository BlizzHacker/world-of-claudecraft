...
const EXPECTED_SEND_COUNT = 146; // includes generic minigame lifecycle + zombie commands.
const EXPECTED_DISPATCH_COUNT = 155; // includes generic minigame lifecycle + zombie cases.
