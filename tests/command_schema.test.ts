...
const EXPECTED_SEND_COUNT = 151; // includes generic minigame lifecycle + arcade commands.
const EXPECTED_DISPATCH_COUNT = 160; // includes generic minigame lifecycle + arcade cases.
