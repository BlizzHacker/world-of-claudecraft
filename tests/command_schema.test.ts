...
const EXPECTED_SEND_COUNT = 153; // + minigame lifecycle/arcade + derby_queue/derby_leave.
const EXPECTED_DISPATCH_COUNT = 162; // + minigame lifecycle/arcade + the two derby cases.
