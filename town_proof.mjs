...
await p.screenshot({path:'/tmp/town1.png'});
// walk toward the smithy/market for a second angle
await p.mouse.click(640,300);
await p.keyboard.down('w'); await new Promise(r=>setTimeout(r,2500)); await p.keyboard.up('w');
await new Promise(r=>setTimeout(r,3000));
await p.screenshot({path:'/tmp/town2.png'});
await br.close();
console.log('done');
