# Phase 35 QA: Verify Implement Platform Arena Brawler Domain

### QA Starter Prompt

~~~text
This is Phase 35 QA of Cryptic Realm Recovery and Modernization: Verify Implement Platform Arena Brawler Domain.
...
Goal: Independently verify every Phase 35 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-35-brawler-domain.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Fuzz simultaneous ledges/hits/ring-outs and vertical boundaries.
- Verify damage scaling and recovery at exact frame edges.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 36 handoff.
