...
Build approved housing client behavior, prove one-to-four-player offline/online visits/building, and checkpoint-promote only after QA PASS.
...
~~~text
This is Phase 44 of Cryptic Realm Recovery and Modernization: Implement Housing Client and Release Checkpoint.
...
Goal: Build approved housing client behavior, prove one-to-four-player offline/online visits/building, and checkpoint-promote only after QA PASS.

STEP 0 - PRE-FLIGHT:
- Verify branch and git status; preserve unrelated/concurrent work; record phase-start commit and UTC timestamp.
- Confirm Phase 43 QA is complete.
...
- docs/cryptic-realm-recovery/phase-44-housing-client-checkpoint.md
...
- feat(housing): add safe client
- test(housing): complete coop matrix
- chore(release): prepare housing checkpoint

STEP 5 - ACCEPTANCE CRITERIA:
- [ ] P1-P4 approved housing flows work with correct ACL/privacy.
- [ ] Quarantined paths remain disabled.
- [ ] Assets/input/mobile/console gates pass.
...
Report status, files, commits, validation, reviewers, QA artifacts, deferrals, feature flags, and Phase 44 QA handoff.
