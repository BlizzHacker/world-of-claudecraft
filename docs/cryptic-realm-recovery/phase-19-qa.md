# Phase 19 QA: Verify Implement Authoritative Flight Domain and Wire

### QA Starter Prompt

~~~text
This is Phase 19 QA of Cryptic Realm Recovery and Modernization: Verify Implement Authoritative Flight Domain and Wire.
...
Goal: Independently verify every Phase 19 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-19-flight-domain-wire.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Fuzz altitude, velocity, terrain edges, no-fly borders, and packet order.
- Test dismount/death/reconnect at every vertical state.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 20 handoff.
