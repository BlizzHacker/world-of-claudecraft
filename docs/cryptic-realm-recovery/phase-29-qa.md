# Phase 29 QA: Verify Implement Exchange Player and Operator Experience

### QA Starter Prompt

~~~text
This is Phase 29 QA of Cryptic Realm Recovery and Modernization: Verify Implement Exchange Player and Operator Experience.
...
Goal: Independently verify every Phase 29 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-29-exchange-client-admin.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Verify every money field sums to reservation.
- Attempt prohibited controls and unauthorized admin access.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 30 handoff.
