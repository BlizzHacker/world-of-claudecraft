...
Build accessible construction/command presentation and prove P1-P4 Eastbrook then Highwatch campaign behavior offline/online.
...
~~~text
This is Phase 39 of Cryptic Realm Recovery and Modernization: Implement Town RTS Client and One-to-Four-Player Integration.
...
Goal: Build accessible construction/command presentation and prove P1-P4 Eastbrook then Highwatch campaign behavior offline/online.

STEP 0 - PRE-FLIGHT:
- Verify branch and git status; preserve unrelated/concurrent work; record phase-start commit and UTC timestamp.
- Confirm Phase 38 QA is complete.
...
- docs/cryptic-realm-recovery/phase-39-rts-client-integration.md
...
- feat(rts): add campaign client
- test(rts): cover four-player towns

STEP 5 - ACCEPTANCE CRITERIA:
- [ ] P1-P4 can operate the campaign accessibly.
- [ ] Eastbrook passes before Highwatch activation.
- [ ] Renderer/performance/console gates pass.
- [ ] Persistence/reconnect/ACL behavior is correct.
...
Report status, files, commits, validation, reviewers, QA artifacts, deferrals, feature flags, and Phase 39 QA handoff.
