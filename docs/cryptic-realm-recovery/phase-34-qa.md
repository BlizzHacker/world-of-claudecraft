# Phase 34 QA: Verify Implement Racing Client and One-to-Four-Player Integration

### QA Starter Prompt

~~~text
This is Phase 34 QA of Cryptic Realm Recovery and Modernization: Verify Implement Racing Client and One-to-Four-Player Integration.
...
Goal: Independently verify every Phase 34 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-34-racing-client-integration.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Compare shared/split camera evidence at phone/desktop viewports.
- Run all player counts with bots and disconnects.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 35 handoff.
