# Phase 37 QA: Verify Define Town RTS Domain, Pilot Towns, and Balance

### QA Starter Prompt

~~~text
This is Phase 37 QA of Cryptic Realm Recovery and Modernization: Verify Define Town RTS Domain, Pilot Towns, and Balance.
...
Goal: Independently verify every Phase 37 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-37-rts-domain-balance.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Run bot simulations across seeds and party sizes.
- Verify no open-world state mutation or unexplained balance literal.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 38 handoff.
