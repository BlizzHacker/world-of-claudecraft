# Phase 20 QA: Verify Implement Flight Client, Camera, and Controls

### QA Starter Prompt

~~~text
This is Phase 20 QA of Cryptic Realm Recovery and Modernization: Verify Implement Flight Client, Camera, and Controls.
...
Goal: Independently verify every Phase 20 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-20-flight-client-camera.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Test mixed ground/air squad layouts and outliers.
- Capture pass/fail screenshots and fail on any console error.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 21 handoff.
