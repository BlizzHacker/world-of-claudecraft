# Phase 17 QA: Verify Implement Mount Persistence and Target-Neutral Entitlements

### QA Starter Prompt

~~~text
This is Phase 17 QA of Cryptic Realm Recovery and Modernization: Verify Implement Mount Persistence and Target-Neutral Entitlements.
...
Goal: Independently verify every Phase 17 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-17-mount-persistence-entitlements.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Inspect Git history/diff for target data leakage.
- Attempt normalization/confusable and arbitrary-item bypasses.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 18 handoff.
