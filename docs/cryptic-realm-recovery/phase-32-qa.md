# Phase 32 QA: Verify Implement Minigame Client Shell and Vale Cup Adapter

### QA Starter Prompt

~~~text
This is Phase 32 QA of Cryptic Realm Recovery and Modernization: Verify Implement Minigame Client Shell and Vale Cup Adapter.
...
Goal: Independently verify every Phase 32 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-32-minigame-client-vale-cup.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Run all prior Vale Cup flows and golden checks.
- Hot-plug controllers and reconnect during every lifecycle state.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 33 handoff.
