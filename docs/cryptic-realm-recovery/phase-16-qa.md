# Phase 16 QA: Verify Implement Mount Domain and Wire Contract

### QA Starter Prompt

~~~text
This is Phase 16 QA of Cryptic Realm Recovery and Modernization: Verify Implement Mount Domain and Wire Contract.
...
Goal: Independently verify every Phase 16 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-16-mount-domain-wire.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Fuzz capability, ownership, transitions, and packet order.
- Compare same input traces across all hosts.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 17 handoff.
