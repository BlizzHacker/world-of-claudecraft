# Phase 27 QA: Verify Implement Exchange Schema, Escrow, and Currency Reservations

### QA Starter Prompt

~~~text
This is Phase 27 QA of Cryptic Realm Recovery and Modernization: Verify Implement Exchange Schema, Escrow, and Currency Reservations.
...
Goal: Independently verify every Phase 27 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-27-exchange-schema-custody.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Crash each transaction between logical steps.
- Reconcile total item count and money supply before/after every fixture.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 28 handoff.
