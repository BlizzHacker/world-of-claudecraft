# Phase 43 QA: Verify Implement Approved Housing Domain and Persistence

### QA Starter Prompt

~~~text
This is Phase 43 QA of Cryptic Realm Recovery and Modernization: Verify Implement Approved Housing Domain and Persistence.
...
Goal: Independently verify every Phase 43 deliverable and acceptance item before completion.
...
STEP 1 - LOAD CONTEXT:
Spawn Explore to summarize state, progress, inventory, checklist, phase-43-housing-domain-persistence.md, full diff, permanent guards, root AGENTS/CLAUDE and governing CLAUDE files. Return every deliverable/criterion, changed surface, flag, test, known issue, environment, and evidence gap.

STEP 2 - QA AUDIT:
Spawn fresh parallel agents.

Correctness:
- Attempt cross-account and stale ACL access.
- Interrupt build/delete/save/reconnect boundaries.
...
Report verdict, finding/fix counts, SHAs, validations, environment, QA artifacts, cleanup, promotion/operation/rollback, flags, deferrals, and Phase 44 handoff.
