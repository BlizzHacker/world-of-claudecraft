...
|---|---|---|
| Arcade racing/brawler | Preview playable offline/online; solo CPU opponents | `9d61ce9be`, `97d576cda` |
...
| Exchange | Custody/provenance core; writes now restricted to Exchange process | `16bea311a`, `6667d48b7` |
| Character/3D viewer | Renderer foundation exists; pixel match/catalog open | prior viewer checkpoints |
