...
const RESULTS = join(ROOT, 'tmp/nonhum_ship_results.ndjson');
const BUDGET = 20000;
...
const jobs = JSON.parse(readFileSync(join(ROOT, 'tmp/nonhum_ship_jobs.json'), 'utf8'));
const done = new Set();
