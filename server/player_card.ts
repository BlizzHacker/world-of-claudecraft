...
const DEFAULT_PRODUCTION_PUBLIC_ORIGIN = 'https://crypticrealm.com';
const TRUSTED_PUBLIC_HOST_ORIGINS = new Map([
  ['crypticrealm.com', DEFAULT_PRODUCTION_PUBLIC_ORIGIN],
  ['www.crypticrealm.com', DEFAULT_PRODUCTION_PUBLIC_ORIGIN],
  ['dev.crypticrealm.com', 'https://dev.crypticrealm.com'],
]);
...
export const PUBLIC_CARD_COPY: Record<PublicCardLocale, PublicCardCopy> = {
  en: {
    gameName: 'Cryptic Realm',
    unknownClass: 'Adventurer',
    levelClass: 'Level {level} {className}',
    description: '{name} is forging a legend in Cryptic Realm. Join the realm.',
    ...
    missingCta: 'Enter Cryptic Realm',
    classes: EN_CLASSES,
  },
  es: {
    gameName: 'Cryptic Realm',
    ...
    description: '{name} está forjando una leyenda en Cryptic Realm. Únete al reino.',
    ...
    missingCta: 'Entrar en Cryptic Realm',
    classes: {
      warrior: 'Guerrero',
      paladin: 'Paladín',
      hunter: 'Cazador',
  ...
  fr_FR: {
    ...
    description: '{name} forge sa légende dans Cryptic Realm. Rejoignez le royaume.',
    ...
    missingCta: 'Entrer dans Cryptic Realm',
    classes: {
      warrior: 'Guerrier',
      paladin: 'Paladin',
      hunter: 'Chasseur',
  ...
  it_IT: {
    ...
    description: '{name} sta forgiando una leggenda in Cryptic Realm. Entra nel reame.',
    ...
    missingCta: 'Entra in Cryptic Realm',
    classes: {
      warrior: 'Guerriero',
      paladin: 'Paladino',
      hunter: 'Cacciatore',
  ...
  de_DE: {
    ...
    description: '{name} schmiedet eine Legende in Cryptic Realm. Betretet das Reich.',
    ...
    missingCta: 'Cryptic Realm betreten',
    classes: {
      warrior: 'Krieger',
      paladin: 'Paladin',
      hunter: 'Jäger',
  ...
  zh_CN: {
    ...
    description: '{name} 正在 Cryptic Realm 中铸就传奇。加入这个国度。',
    cta: '铸就你的传奇',
    missingTitle: '未找到卡片',
    missingHeading: '这张卡片已不可用。',
    missingDescription: '它可能已被撤下，或从未存在。',
    missingCta: '进入 Cryptic Realm',
    classes: {
      warrior: '战士',
      paladin: '圣骑士',
      hunter: '猎人',
  ...
  zh_TW: {
    ...
    description: '{name} 正在 Cryptic Realm 中鑄就傳奇。加入這個國度。',
    cta: '鑄就你的傳奇',
    missingTitle: '找不到卡片',
    missingHeading: '這張卡片已不可用。',
    missingDescription: '它可能已被移除，或從未存在。',
    missingCta: '進入 Cryptic Realm',
    classes: {
      warrior: '戰士',
      paladin: '聖騎士',
      hunter: '獵人',
  ...
  pt_BR: {
    ...
    description: '{name} está forjando uma lenda em Cryptic Realm. Entre no reino.',
    cta: 'Forje sua lenda',
    ...
    missingCta: 'Entrar em Cryptic Realm',
    classes: {
      warrior: 'Guerreiro',
      paladin: 'Paladino',
      hunter: 'Caçador',
  ...
  ru_RU: {
    ...
    description: '{name} создает легенду в Cryptic Realm. Присоединяйтесь к миру.',
    ...
    missingCta: 'Войти в Cryptic Realm',
    classes: {
      warrior: 'Воин',
      paladin: 'Паладин',
      hunter: 'Охотник',
